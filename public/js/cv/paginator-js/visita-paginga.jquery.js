    ...
    "use strict";
        ...
        $.extend(paginga.prototype,
        {
            ...
            bindEvents: function()
            {
                ...
                {
                    //Validación para prueba competencias

                    
                    if (!validateAnswers(plugin.currentPage)) {
                    }else {
                        plugin.showNextPage.call(plugin);

                        if(plugin.currentPage==plugin.totalPages){
                            $("#btn-guardar").show();
                        }
                    }
                });
            ...
            showPage: function()
            {
                ...
                if(pageNumbers)
                {
                    ...
                    for(var pageNumber = firstPage; pageNumber <= lastPage; pageNumber++)
                    {
                        ...
                        pageNumbers.append("<li><a href='javascript:void(0);' data-page='" + pageNumber + "' class='" + className + "'>" + pageNumber + "</a></li>");
                    }
