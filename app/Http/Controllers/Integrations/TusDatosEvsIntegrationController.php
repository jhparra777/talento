...
class TusDatosEvsIntegrationController extends Controller
{
    /**
     * 
     */
    ...
    public function consultarPersonaEVS(Request $request)
    {
        ...
        if ($convertResponse->error == 'Documento consultado previamente') {
            ...
            $tusdatos = TusDatosEvs::where('req_id', $request->req_id)->where('user_id', $request->user_id)->orderBy('id', 'DESC')->first();
    ...
    //CRON
    public function consultarResultadoEvs()
    {
        /**
         * PRUEBA
         * 
        ...
        $registrosConsultas = TusDatosEvs::where('status', 'procesando')->get();
        ...
        foreach ($registrosConsultas as $registro) {
            ...
            if (empty($procesoTusdatos)) {
                ...
                $procesoTusdatos->fill([
                    ...
                    'observaciones'              => 'Consulta de antecedentes EVS',
                    'proceso'                    => "CONSULTA_ANTECEDENTES_EVS"
                ]);
            }
            ...
            switch ($convertResponse->estado) {
                case 'finalizado':
                    $tusdatos = TusDatosEvs::where('req_id', $registro->req_id)->where('user_id', $registro->user_id)->orderBy('id', 'DESC')->first();
                    ...
                    if (!empty($procesoTusdatos)) {
                        $procesoTusdatos->observaciones = 'Consulta de antecedentes EVS';
                        $procesoTusdatos->apto = 1;
                    }
    ...
    public function reintentarConsultaEvs()
    {
        /**
    ...
    //
    public function consultarReporteEvs()
    {
        /**
         * Id
    ...
    public function consultarReportePdfEvs(Request $request)
    {
        /**
         * Id
         * 5d9e00483800a5071688a101
        ...
        $tusdatosRegistro = TusDatosEvs::find($request->check);
    ...
    public function consultarReporteJsonEvs()
    {
        /**
         * Id
         * 5d9e00483800a5071688a101
    ...
    // Modal
    public function enviarConsultaEvs(Request $request)
    {
        $req_id = $request->req_id;
        $user_id = $request->user_id;
        ...
        $consultas_realizadas = TusDatosEvs::where('status', 'finalizado')
