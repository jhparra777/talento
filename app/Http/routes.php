...
Route::get("tusdatos-reporte", ["as" => "tusdatos_reporte", "uses" => "Integrations\TusDatosIntegrationController@consultarReportePdf"]);
...
Route::group(['prefix' => 'cv'], function () {
    ...
    */
    ...
    Route::post("certificados-estudios", ["as" => "certificados_estudios", "uses" => "CertificadoEstudioController@index"]);
    Route::post("guardar-certificado-estudio", ["as" => "guardar_certificado_estudio", "uses" => "CertificadoEstudioController@store"]);
    Route::post("ver-certificado-estudio", ["as" => "ver_certificado_estudio", "uses" => "CertificadoEstudioController@show"]);
    Route::post("eliminar-certificado-estudio", ["as" => "eliminar_certificado_estudio", "uses" => "CertificadoEstudioController@destroy"]);
    /* fin certificados de estudios */

    /* certificados de experiencia */
    Route::post("certificados-experiencias", ["as" => "certificados_experiencias", "uses" => "CertificadoExperienciaController@index"]);
    Route::post("guardar-certificado-experiencia", ["as" => "guardar_certificado_experiencia", "uses" => "CertificadoExperienciaController@store"]);
    Route::post("ver-certificado-experiencia", ["as" => "ver_certificado_experiencia", "uses" => "CertificadoExperienciaController@show"]);
    Route::post("eliminar-certificado-experiencia", ["as" => "eliminar_certificado_experiencia", "uses" => "CertificadoExperienciaController@destroy"]);
    /* fin certificados de experiencia */
    ...
    Route::group(['middleware' => ['valida_cv', "sesion_datos_basicos", "valida_datos_basicos"]], function () {
        ...
        Route::post("aplicar_oferta", ["as" => "aplicar_oferta", "uses" => "OfertaController@aplicar_oferta"]);
...
Route::group(['prefix' => 'admin'], function () {
    ...
    */
    ...
    Route::get('salud_odupacional', ['as' => 'admin.salud_ocupacional', 'uses' => 'ContratacionController@salud_ocupacional']);
    Route::get('gestion_salud_odupacional/{orden}', ['as' => 'admin.gestion_salud_ocupacional', 'uses' => 'ContratacionController@gestion_salud_ocupacional']);
    ...
    Route::get('aceptacion-de-politica-tratamiento-de-datos/{user_id}/{req}', [
    ...
    Route::group(['middleware' => ['valida_admin', 'sesion_admin']], function () {
        ...
        */
        ...
        Route::get("gestionar-visita-domiciliaria/{ref_id}", ["as" => "admin.gestionar_visita_domiciliaria", "uses" => "VisitasDomiciliariasController@gestionarVisita"]);
        ...
        Route::get("gestionar_referencia/{ref_id}", ["as" => "admin.gestionar_referencia", "uses" => "ReclutamientoController@gestionar_referencia"]);
        Route::get("gestionar_referencia_estudios/{ref_id}", ["as" => "admin.gestionar_referencia_estudios", "uses" => "ReclutamientoController@gestionar_referencia_estudios"]);
        ...
        //
        Route::get("nuevo-centro-costo", ["as" => "admin.nuevo_centro_costo", "uses" => "NegocioController@nuevo_centro_costo"]);
...
Route::group(['prefix'=>'reclutamiento'], function () {
    require __DIR__ . '/Routes/reclutamiento_externo.php';
});
