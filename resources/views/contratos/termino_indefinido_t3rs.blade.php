...
<body>
    ...
    <table class="mt-4 mb-2" width="100%">
        <tr>
            <th class="text-center">
                <p>CONTRATO LABORAL A TÉRMINO INDEFINIDO</p>
            </th>
        </tr>
    </table>
        ...
        <tr>
            <td>
                <p>
                    ...
                    <br/>
                    a) Ejecutar y desarrollar las funciones propias del cargo de {{ $reqcandidato->nombre_cargo_especifico }}
                    <br/>
                ...
                <tr>
                    <td width="40%">
                        <div style="width: 100%; margin: 4em;">
                            <img src="{{ asset('contratos/Firma-Jorge-t3rs.png') }}" width="200" {{--style="width: 60%;"--}}>
