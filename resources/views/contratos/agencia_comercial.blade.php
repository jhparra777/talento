...
<body>
        ...
        <tr>
            <th class="text-center">
                <p>CONTRATO DE TRABAJO
                    <br/><br/>
                POR EL TIEMPO QUE DURE LA REALIZACIÓN DE LA OBRA O LABOR CONTRATADA</p>
            </th>
        </tr>
    </table>
    ...
    <table class="center table-contract justify" width="95%">
        ...
        <tr>
            ...
            <td colspan="2">
                {{ $candidato->numero_libreta }} - {{ $candidato->distrito_militar }}
            </td>
            @else
            <td colspan="4">
              {{ ucwords(mb_strtolower($candidato->dec_tipo_doc))}}
        ...
        <tr>
            ...
            <td colspan="4">
                {{ $candidato->fecha_nacimiento }} @if($lugarnacimiento != null) {{$lugarnacimiento->value }} @endif
            </td>
        </tr>
