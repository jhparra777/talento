...
<body>
    ...
    <table class="center table justify" width="97%">
        ...
        <tr>
            ...
            <td colspan="4" class="text-left" width="25%">
        ...
        <tr>
            ...
            <td colspan="4">
                @if(isset($reqcandidato->termino_inicial_contrato))
                    {{ $reqcandidato->termino_inicial_contrato }}
                @else
                    {{-- Para previsualización del contrato --}}
                    @if(isset($requerimiento_informacion->termino_inicial_contrato))
                        {{ $requerimiento_informacion->termino_inicial_contrato }}
                    @endif
                @endif
            </td>
        </tr>
