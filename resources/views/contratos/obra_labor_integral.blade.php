...
<body>
        ...
        <tr>
            <th class="text-center">
                <p>CONTRATO DE TRABAJO POR EL TIEMPO
                    <br/><br/>
                QUE DURE LA REALIZACIÓN DE LA OBRA O LABOR CONTRATADA CON SALARIO INTEGRAL</p>
            </th>
        </tr>
    </table>
    ...
    <table class="center table-contract justify" width="95%">
        ...
        <tr>
            ...
            <td colspan="4">
                <b>ARL:</b> <b>AFP:</b> {{ $candidato->entidades_afp_des }} <b>EPS:</b> {{ $candidato->entidades_eps_des }}
            </td>
        </tr>
        ...
        <tr>
            <th class="text-left">
                Obra o Labor particular contratada:
            </th>
        ...
        <tr>
            <th class="text-left">
                Salario  básico integral  $ 

                <br/>Factor prestacional: 30 %
            </th>
