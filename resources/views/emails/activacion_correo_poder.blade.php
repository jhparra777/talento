...
<html lang="es">
    ...
    <body style="background-color: #fe7b00; color: #555555; font-family: helvetica; text-align: justify; font-size: 0.9em;">
                        ...
                        <table width="700" bgcolor="#ffffff" align="center" style="border:1px solid #cccccc;margin:20px auto;color:#666666;font-family:Segoe UI,Arial,Verdana;font-size:15px">  
                            <tbody><tr><td>
                                        <table border="0" cellspacing="0" cellpadding="0" style="padding:20px">
                                            <tbody><tr>
                                                    <td width="180" valign="top"><a target="_blank" style="margin:0;padding:0" href="{{route("login")}}"><img width="150" border="0" src="{{$message->embed("img/logo_poder.PNG")}}" class="CToWUd"></a></td>
                                                    <td width="500" valign="middle" style="border-top:1px solid #e5e5e5;border-bottom:1px solid #e5e5e5">
                                                        <font face="Segoe UI,Arial,Verdana" color="#444444" style="font-size:18px">Hola <b>{{$datos_basicos->nombres." ".$datos_basicos->primer_apellido." ".$datos_basicos->segundo_apellido}}</b>,</font><br>
                                                        <font face="Segoe UI,Arial,Verdana" color="#666666" style="font-size:15px">
                                                        ¡Gracias por registrarte en empleos en acción! Ahora estas un paso más cerca de encontrar tu oportunidad laboral deseada, vamos a empezar con tu registro teniendo en cuenta los siguientes pasos:</font>
                                                    </td>
                                                </tr>
                                            </tbody></table>
                                        <table border="0" cellspacing="0" cellpadding="0" style="padding:0 20px">
                                            <tbody><tr>
                                                    ...
                                                    <td width="160" valign="top" align="right">
                                                        <div style="padding:3px 10px;background:#fe8c4e;border:1px solid #f1f1f1">
                                                            <font face="Segoe UI,Arial,Verdana" color="#ffffff" style="font-size:20px"><b>Paso 1</b></font>
                                                        </div>
                                                    </td>
                                                    <td width="30" valign="top"></td>
                                                    <td width="490" valign="top" style="padding-top:5px">
                                                        <font face="Segoe UI,Arial,Verdana" color="#666666" style="font-size:15px"><b>Verifica</b> tu email y activa tu <span class="il">cuenta</span>. 
                                                            <!--Aquí tienes los detalles:--> </font><br><br>

                                                        <font face="Segoe UI,Arial,Verdana" color="#666666" style="font-size:15px"><b>Link de verificación :</b></font><br>
                                                        <a target="_blank" style="color:#a18412;border-bottom:1px dotted #a18412;text-decoration:none;font-size:13px" href="{{route("verificar_cuenta",["id"=>$user->id,"hash"=>$hash])}}">{{route("verificar_cuenta",["id"=>$user->id,"hash"=>$hash])}}</a><br><br>
                                        ...
                                        <table border="0" cellspacing="0" cellpadding="0" style="padding:20px">
                                            <tbody><tr>
                                                    <td width="160" valign="top" align="right">
                                                        <div style="padding:3px 10px;background:#fe8c4e;border:1px solid #f1f1f1">
                                                            <font face="Segoe UI,Arial,Verdana" color="#ffffff" style="font-size:20px"><b>Paso 2</b></font>
                                                    ...
                                                    <td width="490" valign="top" style="padding-top:5px">
                                                        <font face="Segoe UI,Arial,Verdana" color="#666666" style="font-size:15px">
                                                        <b><a target="_blank" style="color:#a18412;border-bottom:1px dotted #a18412;text-decoration:none" href="{{route("login")}}">Accede</a></b> a tu <span class="il">cuenta</span> en <a href="https://www.empleosenaccion.com">www.empleosenaccion.com.</a>
                                                        </font>
                                                    </td>
