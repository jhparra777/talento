...
<div class="col-right-item-container">
    <div class="container-fluid">
        ...
        {!! Form::model(Request::all(),["class"=>"form-horizontal form-datos-basicos","id"=>"fr_datos_basicos","role"=>"form","route"=>"cv.guardar_nuevo","method"=>"POST","files"=>true]) !!}
        ...
        <div class="row">
            ...
            <div class="col-sm-6 col-lg-6">
                <div class="form-group">
                    ...
                    <div class="col-md-7">
                        {!! Form::text("fecha_expedicion_id",null,["class"=>"form-control", "id"=>"fecha_expedicion" ,"placeholder"=>"Fecha Expedición" ]) !!}
            ...
            <div class="col-sm-6 col-lg-6">
                <div class="form-group">
                    ...
                    <div class="col-md-7">
                        ...
                        {!! Form::text("txt_nacimiento",null,["id"=>"txt_nacimiento","class"=>"form-control","placheholder"=>"Digita cuidad"]) !!}
            ...
            <div class="col-sm-6 col-lg-6">
                <div class="form-group">
                    ...
                    <div class="col-md-7">
                        ...
                        {!! Form::text("txt_residencia",null,["id"=>"txt_residencia","class"=>"form-control","placheholder"=>"Digita cuidad"]) !!}
                    </div>
                </div>
        ...
        <div class="row" id="info-adicional">
            ...
            <div class="col-sm-6 col-lg-6">
                <div class="form-group">
                    ...
                    <div class="col-md-5">
                        {!! Form::checkbox("situacion_militar_definida",1,null,["class"=>"checkbox-preferencias"]) !!}
