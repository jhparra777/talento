    ...
    <tbody>
        ...
        <tr>
            <td class="m_-7484884227191431181m_-8044308263189181155fs13" style="font-size:14px;line-height:20px;padding-top:10px;padding-right:30px;padding-bottom:10px;padding-left:30px;text-align:left;color:#353e4a">
                    ...
                    <p>Aprobado para contratación candidato <strong>{{$candidato->name}}</strong> en requerimiento <strong>{{$req->requerimiento_id}}</strong></p>
               
            </td>
        </tr>
        <tr>
            <td class="m_-7484884227191431181m_-8044308263189181155fs13" style="font-size:14px;line-height:20px;padding-top:10px;padding-right:30px;padding-bottom:10px;padding-left:30px;text-align:left;color:#353e4a">
                Para gestionar haz click en el siguiente botón.
            </td>
        </tr>
    </tbody>
</table>
    ...
    <tbody>
        <tr>
            <td style="background-color:#ee1e50;font-family:Arial,sans-serif;border-radius:5px;color:#ffffff;text-decoration:none;text-align:center">
                <a data-saferedirecturl="" href="{{ route('admin.reclutamiento').'?numero_req='.$req->id}}" style="color:#ffffff;text-decoration:none;width:250px;display:table-cell;height:50px;vertical-align:middle;font-size:18px" target="_blank">
                    <strong>
                        Ir a gestionar
                    </strong>
                </a>
