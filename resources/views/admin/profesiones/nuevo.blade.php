...
<div class="col-md-8 col-md-offset-2">
    {!! Form::open(["id"=>"fr_profesiones","route"=>"admin.profesiones.guardar","method"=>"POST"]) !!}
    {!! Form::hidden("active",1,["class"=>"form-control","placeholder"=>"active" ]); !!}

    <h3>Nuevo   Profesiones</h3>
    ...
    {!! FuncionesGlobales::valida_boton_req("admin.profesiones.guardar","Guardar","submit","btn btn-success") !!}
