...
<div class="col-md-8 col-md-offset-2">
    {!! Form::model($registro,["id"=>"fr_profesiones","route"=>"admin.profesiones.actualizar","method"=>"POST"]) !!}
    {!! Form::hidden("id") !!}

    <h3>Editar Profesiones</h3>
    ...
    {!! FuncionesGlobales::valida_boton_req("admin.profesiones.actualizar","Actualizar","submit","btn btn-success") !!}
