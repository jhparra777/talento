...
<div class="col-md-8 col-md-offset-2">
    {!! Form::open(["id"=>"fr_tipos_experiencias","route"=>"admin.tipos_experiencias.guardar","method"=>"POST"]) !!}
    {!! Form::hidden("active",1,["class"=>"form-control","placeholder"=>"active" ]); !!}

    <h3>Nuevo   Tipos Experiencias</h3>
    ...
    {!! FuncionesGlobales::valida_boton_req("admin.tipos_experiencias.guardar","Guardar","submit","btn btn-success") !!}
