...
<div class="col-md-8 col-md-offset-2">
    {!! Form::model($registro,["id"=>"fr_tipos_experiencias","route"=>"admin.tipos_experiencias.actualizar","method"=>"POST"]) !!}
    {!! Form::hidden("id") !!}

    <h3>Editar Tipos Experiencias</h3>
    ...
    {!! FuncionesGlobales::valida_boton_req("admin.tipos_experiencias.actualizar","Actualizar","submit","btn btn-success") !!}
