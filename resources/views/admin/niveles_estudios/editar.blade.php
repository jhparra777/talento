...
<div class="col-md-8 col-md-offset-2">
    {!! Form::model($registro,["id"=>"fr_niveles_estudios","route"=>"admin.niveles_estudios.actualizar","method"=>"POST"]) !!}
    {!! Form::hidden("id") !!}

    <h3>Editar Niveles Estudios</h3>
    ...
    {!! FuncionesGlobales::valida_boton_req("admin.niveles_estudios.actualizar","Actualizar","submit","btn btn-success") !!}
