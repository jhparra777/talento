...
<div class="col-md-8 col-md-offset-2">
    {!! Form::open(["id"=>"fr_clases_libretas","route"=>"admin.clases_libretas.guardar","method"=>"POST"]) !!}


    <h3>Nuevo   Clases Libretas</h3>
...
<div class="col-md-12 form-group">
    ...
    {!! FuncionesGlobales::valida_boton_req("admin.clases_libretas.guardar","Guardar","submit","btn btn-success") !!}
