...
<div class="col-md-8 col-md-offset-2">
    {!! Form::model($registro,["id"=>"fr_clases_libretas","route"=>"admin.clases_libretas.actualizar","method"=>"POST"]) !!}
    {!! Form::hidden("id") !!}

    <h3>Editar Clases Libretas</h3>
...
<div class="col-md-12 form-group">
    ...
    {!! FuncionesGlobales::valida_boton_req("admin.clases_libretas.actualizar","Actualizar","submit","btn btn-success") !!}
