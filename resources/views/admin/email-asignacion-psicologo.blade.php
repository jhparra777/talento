                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td class="m_-7484884227191431181m_-8044308263189181155fs13" style="font-size:14px;line-height:20px;padding-top:10px;padding-right:30px;padding-bottom:10px;padding-left:30px;text-align:left;color:#353e4a">
                                                    <b>
                                                      Te informamos que has sido asignado a un requerimiento.
                                                    ...
                                                    @if(isset($requerimiento->solicitud->centrobeneficio))
                                                     ...
                                                     @endif
                                                        ...
                                                        <div class="col-md-6">
                                                            ...
                                                            <div class="col-md-6">
                                                                {{ $requerimiento->solicitud->user()->name }}
                                                            </div>
                                                        </div>
                                                        <!-- -->
                                                        <div class="col-md-6">
                                                            ...
                                                            <div class="col-md-6">
                                                                {{ $requerimiento->solicitud->cargoGenerico()->descripcion }}
                                                            </div>
                                                        </div>
                                                        <!-- -->
                                                        ...
                                                        {{--<div class="col-md-6">
                                                            ...
                                                            <div class="col-md-6">
                                                                {{ $requerimiento->solicitud->jornada()->descripcion }}
                                                            </div>
                                                        </div>--}}
                                                        <!-- -->
                                                        <div class="col-md-6">
                                                       ...
                                                       {{--}} <div class="col-md-6">
                                                        ...
                                                        @if ($requerimiento->solicitud->documento != "" || $requerimiento->solicitud->documento != null)
                                                            <div class="col-md-6">
                                                            <div class="col-md-6">
                                                                <strong>
                                                                    Documento adjunto
                                                            ...
                                                            <div class="col-md-6">
                                                                <a href="{{ route('home') }}/documentos_solicitud/{{ $requerimiento->solicitud->documento }}" target="_blank">
                                                                    Ver documentos
                                                                </a>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-md-12">
                                                            ...
                                                            <div class="col-md-12">
                                                                {{ $requerimiento->solicitud->recursos }}
                                                            </div>
                                                        </div>
                                                    </div>
                                            ...
                                            <tr>
                                                <td class="m_-7484884227191431181m_-8044308263189181155fs13" style="font-size:14px;line-height:20px;padding-top:10px;padding-right:30px;padding-bottom:10px;padding-left:30px;text-align:left;color:#353e4a">
                                                    Haz click en el siguiente botón para ir gestionar el requerimiento.
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
                                        ...
                                        <tbody>
                                            <tr>
                                                <td style="background-color:#ee1e50;font-family:Arial,sans-serif;border-radius:5px;color:#ffffff;text-decoration:none;text-align:center">
                                                    <a data-saferedirecturl="" href="{{ route('admin.reclutamiento') }}?num_req={{$requerimiento->id}}" style="color:#ffffff;text-decoration:none;width:250px;display:table-cell;height:50px;vertical-align:middle;font-size:18px" target="_blank">
                                                        <strong>
                                                            Ir a gestionar
                                                        </strong>
                                                    </a>
