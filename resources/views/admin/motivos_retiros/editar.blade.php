...
<div class="col-md-8 col-md-offset-2">
    {!! Form::model($registro,["id"=>"fr_motivos_retiros","route"=>"admin.motivos_retiros.actualizar","method"=>"POST"]) !!}
    {!! Form::hidden("id") !!}

    <h3>Editar Motivos Retiros</h3>
    ...
    {!! FuncionesGlobales::valida_boton_req("admin.motivos_retiros.actualizar","Actualizar","submit","btn btn-success") !!}
