...
<div class="col-md-8 col-md-offset-2">
    {!! Form::open(["id"=>"fr_motivos_retiros","route"=>"admin.motivos_retiros.guardar","method"=>"POST"]) !!}
    {!! Form::hidden("active",1,["class"=>"form-control","placeholder"=>"active" ]); !!}

    <h3>Nuevo   Motivos Retiros</h3>
    ...
    {!! FuncionesGlobales::valida_boton_req("admin.motivos_retiros.guardar","Guardar","submit","btn btn-success") !!}
