...
<div class="col-md-8 col-md-offset-2">
    {!! Form::model($registro,["id"=>"fr_tipo_identificacion","route"=>"admin.tipo_identificacion.actualizar","method"=>"POST"]) !!}
    {!! Form::hidden("id") !!}
    ...
    {!! FuncionesGlobales::valida_boton_req("admin.tipo_identificacion.actualizar","Actualizar","submit","btn btn-success") !!}
