...
<div class="col-md-8 col-md-offset-2">
    {!! Form::open(["id"=>"fr_tipo_identificacion","route"=>"admin.tipo_identificacion.guardar","method"=>"POST"]) !!}
    {!! Form::hidden("active",1,["class"=>"form-control","placeholder"=>"active" ]); !!}

    <h3>Nuevo   Tipo Identificacion</h3>
    ...
    {!! FuncionesGlobales::valida_boton_req("admin.tipo_identificacion.guardar","Guardar","submit","btn btn-success") !!}
