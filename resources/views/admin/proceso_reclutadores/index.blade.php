...
<div class="col-md-12" id="mensaje-resultado">
    <div class="alert alert-danger alert-dismissible" role="alert">
        ...
        <p>EL reguistro numero {{++$key}} tiene los siguientes errores</p>
        <ul>
...
@endif
    ...
    <div class="col-md-6">
        <h3>Reclutamiento</h3>
        {!! Form::model(Request::all(),["method"=>"get","route"=>"admin.proceso_reclutadores"]) !!}
        ...
        <a href="{{route("admin.proceso_reclutadores")}}" type="button" class="btn btn-warning">Limpiar</a>
        {!! Form::close() !!}
    </div>
<!--
    ...
    <div class="col-md-6">
        ...
        {!! Form::model(Request::all(),["method"=>"post","route"=>"admin.cargar_bd","files"=>true]) !!}
        <div class="form-group col-md-12">
            {!! Form::label('identificacion', 'Cédula') !!}
...
-->
    ...
    @else
        ...
        <!-- ruta de reclutamiento viejo admin.guardar_proceso_reclutadores -->
            ...
            <div class="col-md-3">
                <div class="bloque" style="background: #FFAA39;">
                    ...
                    <div class="form-group col-md-12">
                        ...
                        <p class="text-danger">{!! FuncionesGlobales::getErrorData("nombres",$errors) !!}</p>
                    </div>
        ...
        <button type="button" class="btn btn-warning enviar_call_center">Enviar Call Center</button>
...
<script>
    $(function () {
        ...
        $(".enviar_call_center").on("click", function () {
            $.ajax({
                type: "POST",
                data: $("#fr_candidatos").serialize(),
                url: "{{route('admin.enviar_call_center_nuevo')}}",
                success: function (response) {
                    if(response.success){
                        mensaje_success(response.mensaje_success);
                        window.location.href = '{{route("admin.proceso_reclutadores")}}';
                    }else{
