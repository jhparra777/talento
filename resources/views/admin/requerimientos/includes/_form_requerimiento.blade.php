        ...
        <div class="panel-body">
            ...
            {{-- <div class="col-md-6">
                <div class="form-group">
                    <label for="inputEmail3" class="control-label">Empresa Contrata: </label>

                    {!! Form::select("empresa_contrata",$empresa_logo,old('empresa_contrata'),["class"=>"form-control | tri-br-1 tri-fs-12 tri-input--focus tri-transition-300", "id" => "empresa_contrata"]); !!}
                    ...
                    <div class="form-group @error('cargo_especifico_id') has-feedback has-error smk-select @enderror">
                        ...
                        <div class="input-group-bt4">
                            ...
                            <span class="input-group-append">
                                <button class="btn btn-default |  tri-txt-purple tri-bg-white tri-bd-purple tri-transition-300 tri-hover-out-purple" type="button" title="Crear nuevo cargo del cliente" onclick="crearCargo();"><i class="fa fa-plus"></i></button>
                            </span>
                        </div>
...
<div class="col-md-12">
    ...
    <div class="panel panel-default">
        <div class="panel-body">
            @include('admin.requerimientos.includes._collapse_campos_multiciudad')
        </div>
    </div>
</div>
...
<div id="contratacion-directa" class="col-md-12">
    ...
    <div class="panel panel-default">
        <div class="panel-body">
            @include('admin.requerimientos.includes._form_contratacion_directa')
        </div>
    </div>
</div>
...
<div class="col-md-12">
    ...
    <div class="panel panel-default">
        <div class="panel-body">
            @include('admin.requerimientos.includes._collapse_campos_candidatos_postulados')
        </div>
    </div>
</div>
@endif
