...
<div class="col-md-8 col-md-offset-2">
    {!! Form::open(["id"=>"fr_tipo_proceso","route"=>"admin.tipo_proceso.guardar","method"=>"POST"]) !!}
    {!! Form::hidden("active",1,["class"=>"form-control","placeholder"=>"active" ]); !!}

    <h3>Nuevo   Tipo Proceso</h3>
    ...
    {!! FuncionesGlobales::valida_boton_req("admin.tipo_proceso.guardar","Guardar","submit","btn btn-success") !!}
