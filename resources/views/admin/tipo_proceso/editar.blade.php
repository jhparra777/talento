...
<div class="col-md-8 col-md-offset-2">
    {!! Form::model($registro,["id"=>"fr_tipo_proceso","route"=>"admin.tipo_proceso.actualizar","method"=>"POST"]) !!}
    {!! Form::hidden("id") !!}

    <h3>Editar Tipo Proceso</h3>
    ...
    {!! FuncionesGlobales::valida_boton_req("admin.tipo_proceso.actualizar","Actualizar","submit","btn btn-success") !!}
