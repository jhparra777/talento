...
<div class="col-md-8 col-md-offset-2">
    {!! Form::open(["id"=>"fr_tipos_identificacion","route"=>"admin.tipos_identificacion.guardar","method"=>"POST"]) !!}


    <h3>Nuevo   Tipos Identificacion</h3>
    ...
    {!! FuncionesGlobales::valida_boton_req("admin.tipos_identificacion.guardar","Guardar","submit","btn btn-success") !!}
