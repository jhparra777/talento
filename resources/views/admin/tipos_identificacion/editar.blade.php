...
<div class="col-md-8 col-md-offset-2">
    {!! Form::model($registro,["id"=>"fr_tipos_identificacion","route"=>"admin.tipos_identificacion.actualizar","method"=>"POST"]) !!}
    {!! Form::hidden("id") !!}

    <h3>Editar Tipos Identificacion</h3>
    ...
    {!! FuncionesGlobales::valida_boton_req("admin.tipos_identificacion.actualizar","Actualizar","submit","btn btn-success") !!}
