...
<div class="col-md-8 col-md-offset-2">
    {!! Form::open(["id"=>"fr_tipos_vehiculos","route"=>"admin.tipos_vehiculos.guardar","method"=>"POST"]) !!}
    {!! Form::hidden("active",1,["class"=>"form-control","placeholder"=>"active" ]); !!}

    <h3>Nuevo   Tipos Vehiculos</h3>
    ...
    {!! FuncionesGlobales::valida_boton_req("admin.tipos_vehiculos.guardar","Guardar","submit","btn btn-success") !!}
