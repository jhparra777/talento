...
<div class="col-md-8 col-md-offset-2">
    {!! Form::open(["id"=>"fr_parentescos","route"=>"admin.parentescos.guardar","method"=>"POST"]) !!}
    {!! Form::hidden("active",1,["class"=>"form-control","placeholder"=>"active" ]); !!}

    <h3>Nuevo   Parentescos</h3>
    ...
    {!! FuncionesGlobales::valida_boton_req("admin.parentescos.guardar","Guardar","submit","btn btn-success") !!}
