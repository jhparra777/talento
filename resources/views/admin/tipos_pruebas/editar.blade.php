...
<div class="col-md-8 col-md-offset-2">
    {!! Form::model($registro,["id"=>"fr_tipos_pruebas","route"=>"admin.tipos_pruebas.actualizar","method"=>"POST"]) !!}
    {!! Form::hidden("id") !!}

    <h3>Editar Tipos Pruebas</h3>
    ...
    {!! FuncionesGlobales::valida_boton_req("admin.tipos_pruebas.actualizar","Actualizar","submit","btn btn-success") !!}
