...
<div class="col-md-8 col-md-offset-2">
    {!! Form::model($registro,["id"=>"fr_tipos_jornadas","route"=>"admin.tipos_jornadas.actualizar","method"=>"POST"]) !!}
    {!! Form::hidden("id") !!}

    <h3>Editar Tipos Jornadas</h3>
    ...
    {!! FuncionesGlobales::valida_boton_req("admin.tipos_jornadas.actualizar","Actualizar","submit","btn btn-success") !!}
