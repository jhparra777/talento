...
<div class="col-md-8 col-md-offset-2">
    {!! Form::model($registro,["id"=>"fr_aspiracion_salarial","route"=>"admin.aspiracion_salarial.actualizar","method"=>"POST"]) !!}
    {!! Form::hidden("id") !!}

    <h3>Editar Aspiracion Salarial</h3>
    ...
    {!! FuncionesGlobales::valida_boton_req("admin.aspiracion_salarial.actualizar","Actualizar","submit","btn btn-success") !!}
