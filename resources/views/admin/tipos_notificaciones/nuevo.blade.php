...
<div class="col-md-8 col-md-offset-2">
    {!! Form::open(["id"=>"fr_tipos_notificaciones","route"=>"admin.tipos_notificaciones.guardar","method"=>"POST"]) !!}


    <h3>Nuevo   Tipos Notificaciones</h3>
    ...
    {!! FuncionesGlobales::valida_boton_req("admin.tipos_notificaciones.guardar","Guardar","submit","btn btn-success") !!}
