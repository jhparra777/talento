...
<div class="col-md-8 col-md-offset-2">
    {!! Form::model($registro,["id"=>"fr_tipos_notificaciones","route"=>"admin.tipos_notificaciones.actualizar","method"=>"POST"]) !!}
    {!! Form::hidden("id") !!}

    <h3>Editar Tipos Notificaciones</h3>
    ...
    {!! FuncionesGlobales::valida_boton_req("admin.tipos_notificaciones.actualizar","Actualizar","submit","btn btn-success") !!}
