...
<div class="col-md-8 col-md-offset-2">
    {!! Form::model($registro,["id"=>"fr_tipo_relaciones","route"=>"admin.tipo_relaciones.actualizar","method"=>"POST"]) !!}
    {!! Form::hidden("id") !!}

    <h3>Editar Tipo Relaciones</h3>
    ...
    {!! FuncionesGlobales::valida_boton_req("admin.tipo_relaciones.actualizar","Actualizar","submit","btn btn-success") !!}
