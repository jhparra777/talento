...
<div class="col-md-8 col-md-offset-2">
    {!! Form::model($registro,["id"=>"fr_tipos_contratos","route"=>"admin.tipos_contratos.actualizar","method"=>"POST"]) !!}
    {!! Form::hidden("id") !!}

    <h3>Editar Tipos Contratos</h3>
    ...
    {!! FuncionesGlobales::valida_boton_req("admin.tipos_contratos.actualizar","Actualizar","submit","btn btn-success") !!}
