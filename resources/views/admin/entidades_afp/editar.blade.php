...
<div class="col-md-8 col-md-offset-2">
    {!! Form::model($registro,["id"=>"fr_entidades_afp","route"=>"admin.entidades_afp.actualizar","method"=>"POST"]) !!}
    {!! Form::hidden("id") !!}

    <h3>Editar Entidades Afp</h3>
    ...
    {!! FuncionesGlobales::valida_boton_req("admin.entidades_afp.actualizar","Actualizar","submit","btn btn-success") !!}
