...
<div class="col-md-8 col-md-offset-2">
    {!! Form::open(["id"=>"fr_entidades_afp","route"=>"admin.entidades_afp.guardar","method"=>"POST"]) !!}


    <h3>Nuevo   Entidades Afp</h3>
    ...
    {!! FuncionesGlobales::valida_boton_req("admin.entidades_afp.guardar","Guardar","submit","btn btn-success") !!}
