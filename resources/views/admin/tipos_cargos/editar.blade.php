...
<div class="col-md-8 col-md-offset-2">
    {!! Form::model($registro,["id"=>"fr_tipos_cargos","route"=>"admin.tipos_cargos.actualizar","method"=>"POST"]) !!}
    {!! Form::hidden("id") !!}

    <h3>Editar Tipos Cargos</h3>
    ...
    {!! FuncionesGlobales::valida_boton_req("admin.tipos_cargos.actualizar","Actualizar","submit","btn btn-success") !!}
