...
<div class="col-md-8 col-md-offset-2">
    {!! Form::open(["id"=>"fr_tipos_cargos","route"=>"admin.tipos_cargos.guardar","method"=>"POST"]) !!}
    {!! Form::hidden("active",1,["class"=>"form-control","placeholder"=>"active" ]); !!}

    <h3>Nuevo   Tipos Cargos</h3>
    ...
    {!! FuncionesGlobales::valida_boton_req("admin.tipos_cargos.guardar","Guardar","submit","btn btn-success") !!}
