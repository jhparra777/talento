...
<div class="col-md-8 col-md-offset-2">
    {!! Form::model($registro,["id"=>"fr_escolaridades","route"=>"admin.escolaridades.actualizar","method"=>"POST"]) !!}
    {!! Form::hidden("id") !!}

    <h3>Editar Escolaridades</h3>
    ...
    {!! FuncionesGlobales::valida_boton_req("admin.escolaridades.actualizar","Actualizar","submit","btn btn-success") !!}
