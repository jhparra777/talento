...
<div class="col-md-8 col-md-offset-2">
    {!! Form::open(["id"=>"fr_escolaridades","route"=>"admin.escolaridades.guardar","method"=>"POST"]) !!}


    <h3>Nuevo   Escolaridades</h3>
    ...
    {!! FuncionesGlobales::valida_boton_req("admin.escolaridades.guardar","Guardar","submit","btn btn-success") !!}
