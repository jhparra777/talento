...
<div class="col-md-8 col-md-offset-2">
    {!! Form::model($registro,["id"=>"fr_motivo_requerimiento","route"=>"admin.motivo_requerimiento.actualizar","method"=>"POST"]) !!}
    {!! Form::hidden("id") !!}

    <h3>Editar Motivo Requerimiento</h3>
    ...
    {!! FuncionesGlobales::valida_boton_req("admin.motivo_requerimiento.actualizar","Actualizar","submit","btn btn-success") !!}
