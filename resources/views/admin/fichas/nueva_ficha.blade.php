...
@section("contenedor")
{!! Form::model(Request::all(),["id"=>"form_ficha","route"=>"admin.guardar_ficha","method"=>"POST"]) !!}

<div class="row">
    <div class="col-md-12 col-xs-6">
        <h3 class="page-header"><i class="fa fa-cube" aria-hidden="true"></i> Crear Ficha Perfil</h3>
        ...
        <div class="table-responsive">
            <table class="table table-striped">
                ...
                <tr>
                    ...
                    <td id="dge_ciudad"></td>
                    <th>Dirección</th>
                    <td id="dge_direccion"></td>
                </tr>
                <tr>
                    <th>Teléfono</th>
                    <td id="dge_telefono"></td>
                    <th></th>
                    <td></td>
                </tr>
            </table>
...
<div class="row">
    ...
    {!! Form::hidden('cargo_generico',null,["id"=>"cargo_generico"]); !!}
    <!--<div class="col-md-6  form-group">
        <label for="inputEmail3" class="col-sm-4 control-label">Cargo genérico:<span class="text-danger">*</span></label>
        <div class="col-sm-8 cargo_generico_container">
            {!! Form::select("cargo_generico",$cargo_generico,null,["class"=>"form-control"]); !!}
        </div>
        <p class="error text-danger direction-botones-center">{!! FuncionesGlobales::getErrorData("cargo_generico",$errors) !!}</p>    
    </div>-->
</div>
<div class='row'>
    <div class="col-md-12 col-xs-6">
        ...
        <div class="col-sm-8">
            <div class="checkbox">
                <label for="entrevista">
                   {!! Form::checkbox('procesos[]', 'entrevista', false,['id'=>'entrevista']); !!}
                    Entrevista
                </label>
            </div>
            <div class="checkbox">
                <label for="entrevista_cliente">
                   {!! Form::checkbox('procesos[]', 'entrevista_cliente', false,['id'=>'entrevista_cliente']); !!}
                    Entrevista con el Cliente
                </label>
            </div>
            <div class="checkbox">
                <label for="validacion">
                   {!! Form::checkbox('procesos[]', 'validacion', false,['id'=>'validacion']); !!}
                    Validación/Revisión
                </label>
            </div>
            <div class="table-responsive  table-docs">
                <table class="table table-bordered">
                    <tbody>
                        ...
                        <tr>
                            <td><input type="checkbox" name='docs[]' id='docs{{$documento->id}}' value='{{$documento->id}}'></td>
            ...
            <div class="checkbox">
                <label for="referenciacion">
                   {!! Form::checkbox('procesos[]', 'referenciacion', false,['id'=>'referenciacion']); !!}
                    Referenciación
                </label>
            </div>
            <div class="checkbox">
                <label for="pro_pruebas_psicotecnicas">
                   {!! Form::checkbox('procesos[]','pruebas_psicotecnicas', false,['id'=>'pro_pruebas_psicotecnicas']); !!}
    ...
    <div class="col-md-6 col-sm-6  form-group">
        ...
        <div class="col-sm-4">
            <label class="radio-inline">
                {!! Form::radio('req_informe_seleccion', 'si',false,['id'=>'req_informe_seleccion_si']); !!}
                SI
            </label>
            <label class="radio-inline">
                {!! Form::radio('req_informe_seleccion', 'no',true,['id'=>'req_informe_seleccion_no']); !!}
                NO
            </label>
...
<div class="row">
    <div class="col-md-6 col-sm-6 form-group">
         ...
         <div class="col-md-8 containers_docs">
             <input type="text" name="docs_adicio[]" placeholder="Documento 1" class="form-control" />
         </div>
    </div>
    <div class="col-md-6 col-sm-6 form-group">
...
<p>
    ...
    {!! FuncionesGlobales::valida_boton_req('admin.guardar_ficha','Guardar','submit','btn btn-primary',null,'form_guardar'); !!}
</p>
</div>
{!! Form::close(); !!}
<script>
    ...
    $(document).on('change','#cliente_id',function(e){
        ...
        if($valor!=""){
            $.ajax({
                ...
                $('#cargo_generico').val(response.cargo.cargo_generico_id);
