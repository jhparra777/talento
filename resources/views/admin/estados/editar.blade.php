...
<div class="col-md-8 col-md-offset-2">
    {!! Form::model($registro,["id"=>"fr_estados","route"=>"admin.estados.actualizar","method"=>"POST"]) !!}
    {!! Form::hidden("id") !!}
    ...
    {!! FuncionesGlobales::valida_boton_req("admin.estados.actualizar","Actualizar","submit","btn btn-success") !!}
