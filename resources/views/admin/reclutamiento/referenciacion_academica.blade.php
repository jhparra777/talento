...
@section('contenedor')
    <h3>Candidatos a referencia académica</h3>
    {!! Form::model(Request::all(),["id"=>"admin.lista_clientes","method"=>"GET"]) !!}
        ...
        <a class="btn btn-warning" href="{{route("admin.referenciacion_academica")}}" >Limpiar</a>
    ...
    <div class="table-responsive">
        <table class="table table-bordered">
            ...
            <tbody>
                ...
                <tr>
                    <td>
                     {!!Form::radio("ref_id[]",$candidato->ref_id,null,["data-url"=>route('admin.gestionar_referencia_estudios',["ref_id"=>$candidato->ref_id])])!!}
