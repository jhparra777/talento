...
<div class="modal-body">
        ...
        {!! Form::model(Request::all(),["id"=>"fr_entrevista_semi"]) !!}
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <p class="error text-danger direction-botones-center">
                        {!! FuncionesGlobales::getErrorData("cargo_aspirado",$errors) !!}</p>
                    </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="col-sm-8">
                     {!! Form::text("entrevistador",$entrevistador,["class"=>"form-control","id"=>"cliente","readonly"=>"readonly"]); !!}
                    </div>
                ...
                <div class="col-md-6">
                    ...
                    <div class="col-sm-8">
                        {!! Form::text("cargo_entrevistador",$cargo_entrevistador,["class"=>"form-control","id"=>"cargo","readonly"=>"readonly"]); !!}
                    </div>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-sm-12">
                        {!! Form::textarea("info_general",$proceso->nombres.$proceso->primer_apellido.", identificad@ con el número de cédula ".$proceso->numero_id.", cuyo teléfono celular es ".$proceso->telefono_movil,["class"=>"form-control","id"=>"textarea","rows"=>"5"]); !!}
                    </div>
                </div>
            </div>
            ...
            <div class="container-fluid">
                ...
                @if($experiencias->count()>0)
                            ...
                            @foreach($experiencias as $experiencia)
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        ...
                                        <p class="error text-danger direction-botones-center">{!! FuncionesGlobales::getErrorData("empresa",$errors) !!}</p>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="col-sm-7">
                                            @if($experiencia->fecha_final != "0000-00-00")
                                                @if ($fecha_hoy->y <= 0)
                                                    {!! Form::text("duracion[]",$fecha_hoy->m." Meses",["class"=>"form-control","id"=>"cliente","readonly"=>"readonly"]); !!}
                                                @else
                                            ...
                                            @else
                                                {!! Form::text("duracion[]",$trabajo,["class"=>"form-control","id"=>"cliente","readonly"=>"readonly"]); !!}
                                            @endif
                                        </div>
                                        <p class="error text-danger direction-botones-center">{!! FuncionesGlobales::getErrorData("cliente",$errors) !!}</p>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <label for="inputEmail3" class="col-sm-4 control-label">#Empleados 
                                            </label>
                                        <div class="col-sm-7">
                                            {!! Form::text("num_empleados[]",NULL,["class"=>"form-control","id"=>"cargo_desem"]); !!}
                                        </div>
                                        <p class="error text-danger direction-botones-center">{!! FuncionesGlobales::getErrorData("num_empleados",$errors) !!}</p>
                                    </div>
                                    
                                    <div class="col-md-6">
                                        <label for="inputEmail3" class="col-sm-5 control-label">A quién le reportaba (nombre y cargo)
                                        </label>
                                        <div class="col-sm-7">
                                ...
                                <div class="row">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8">
                                             <label class="switchBtn">
                                              {!! Form::checkbox("personas_a_cargo[]",1,0,["class"=>"checkbox-preferencias","id"=>"switch"]) !!}
                                             <div class="slide"></div>
                                             </label>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="col-sm-7">
                                            {!! Form::text("cant_a_cargo[]",NULL,["class"=>"form-control","id"=>"cargo_desem"]); !!}
                                        </div>
                                        <p class="error text-danger direction-botones-center">{!! FuncionesGlobales::getErrorData("aspecto_familiar",$errors) !!}</p>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="col-sm-12">
                                            {!! Form::textarea("motivo_retiro[]",$experiencia->desc_motivo,["class"=>"form-control","id"=>"fortalezas","rows"=>"3","placeholder"=>"Motivo retiro"]); !!}
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="box box-info collapsed-box">
                        <h4 class="box-header with-border">EXPERIENCIAS ADICIONALES(opcional) <div class="box-tools pull-right">
                        <button type="button" class="btn btn-box-tool" data-toggle="collapse" data-target="#demo"> <i class="fa fa-minus"></i></button></div> </h4>
                    </div>
                    ...
                    <div id="demo" class="collapse">
                        @for($i = 1; $i<=5; $i++)
                            ...
                            <div class="row">
                                <span>   </span><h4>Experiencia Adiconal {{$i}}</h4><hr>

                                <div class="col-md-4">
                                    <label for="inputEmail3" class="col-sm-4 control-label"> Empresa</label>
                                    <div class="col-sm-7">
                                        {!! Form::text("n_empresa[]",null,["class"=>"form-control","id"=>"empresa"]); !!}
                                    </div>
                                ...
                                <div class="col-md-4">
                                    <label for="inputEmail3" class="col-sm-4 control-label"> Cargo</label>
                                    <div class="col-sm-7">
                                        {!! Form::text("n_cargo_desem[]",null,["class"=>"form-control","id"=>"cargo_desem"]); !!}
                                    </div>
                                    <p class="error text-danger direction-botones-center">{!! FuncionesGlobales::getErrorData("cargo_desem",$errors) !!}</p>
                                </div>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="col-sm-7">
                                        ...
                                        {!! Form::text("n_duracion[]",null,["class"=>"form-control","id"=>"n_duracion"]); !!}
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="col-sm-12">
                                        {!! Form::textarea("n_dedicacion_empresa[]",null,["class"=>"form-control","id"=>"fortalezas","rows"=>"3","placeholder"=>"A que se dedica la empresa"]); !!}
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="col-sm-7">
                                        {!! Form::text("n_num_empleados[]",NULL,["class"=>"form-control","id"=>"cargo_desem"]); !!}
                                    </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="col-sm-7">
                                        {!! Form::text("n_jefe[]",null,["class"=>"form-control","id"=>"cliente"]); !!}
                                    </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-8">
                                            <label class="switchBtn">
                                                {!! Form::checkbox("n_personas_a_cargo[]",1,0,["class"=>"checkbox-preferencias","id"=>"switch"]) !!}
                                                <div class="slide"></div>
                                            </label>
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="col-sm-7">
                                        {!! Form::text("n_cant_a_cargo[]",NULL,["class"=>"form-control","id"=>"cargo_desem"]); !!}
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="col-sm-12">
                                        {!! Form::textarea("n_responsabilidades[]",null,["class"=>"form-control","id"=>"fortalezas","rows"=>"3","placeholder"=>"Responsabilidades principales (se puede profundizar en las relacionadas con el cargo aspirado):"]); !!}
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">    
                                    <div class="col-sm-12">
                                        {!! Form::textarea("n_logros[]",null,["class"=>"form-control","id"=>"fortalezas","rows"=>"3","placeholder"=>"Logros relevantes (se puede profundizar en el \"como\" se llegó a la consecución de ese logro para evidenciar competencias requeridas):"]); !!}
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="col-sm-12">
                                        {!! Form::textarea("n_motivo_retiro[]",null,["class"=>"form-control","id"=>"fortalezas","rows"=>"3","placeholder"=>"Motivo retiro"]); !!}
                                    </div>
                                </div>
                            </div>
                            <br><br><br>
            ...
            <div class="container-fluid">
                <h3><p style="text-align: center;">FORTALEZAS FRENTE AL CARGO @if(route('home') == "http://komatsu.t3rsc.co" || route('home') == "https://komatsu.t3rsc.co")<span>*</span>@endif </p></h3>
                <hr>

                <div class="row">
                    <div class="col-md-12">                    
                        <div class="col-sm-12">
                            {!! Form::textarea("fortalezas",null,["class"=>"form-control","id"=>"fortalezas","rows"=>"5","placeholder"=>"*Describir fortalezas que, por los relatos hechos por el candidato, puedan evidenciarse y que sean relevantes para el cargo aspirado.
                                *Puede indagar sobre evaluaciones de desempeño previasy/o feedback recibido anteriormente por jefes, compañeros, colaboradores o cualquier otra persona de quien haya recibido retroalimentación."]); !!}
                        </div>
                    </div>
                </div>

                <div class="row">
                    <h3><p style="text-align: center;">OPORTUNIDADES DE MEJORA FRENTE AL CARGO @if(route('home') == "http://komatsu.t3rsc.co" || route('home') == "https://komatsu.t3rsc.co") <span>*</span> @endif </p></h3>
                    <hr>
                    
                    <div class="col-sm-12">
                        {!! Form::textarea("opor_mejora",null,["class"=>"form-control","id"=>"opor_mejora","rows"=>"5","placeholder"=>"*Describir aspectos por mejorar que, por los relatos hechos por el candidato, puedan evidenciarse y que sean relevantes para el cargo aspirado.
                            *Puede indagar sobre evaluaciones de desempeño previasy/o feedback recibido anteriormente por jefes, compañeros, colaboradores o cualquier otra persona de quien haya recibido retroalimentación."]); !!}
                    </div>
                    <p class="error text-danger direction-botones-center">{!! FuncionesGlobales::getErrorData("opor_mejora",$errors) !!}</p>
                </div>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="col-sm-6">
                              <div class="form-group">
                                ...
                                <div class="col-md-7">
                                {!! Form::text("idioma_1",null,["class"=>"form-control","id"=>"idioma_1"]); !!}
                             ...
                             <br>
                              <div class="form-group">
                                ...
                                <div class="col-md-7">
                                {!! Form::text("nivel_1",null,["class"=>"form-control","id"=>"nivel_1"]); !!}
                        ...
                        <div class="col-sm-6">
                              <div class="form-group">
                                ...
                                <div class="col-md-7">
                                {!! Form::text("idioma_2",null,["class"=>"form-control","id"=>"idioma_2"]); !!}
                             ...
                             <div class="form-group">
                                 <label for="trabajo-empresa-temporal" class="col-md-2 control-label">Nivel</label>
                                <div class="col-md-7">
                                {!! Form::text("nivel_2","",["class"=>"form-control","id"=>"nivel2"]); !!}
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                 <div class="form-group">
                                     {!! Form::textarea("herramientas",null,["class"=>"form-control","id"=>"textarea","rows"=>"3","placeholder"=>"Herramientas informaticas/softwares"]); !!}
                                </div>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                 <div class="form-group">
                                   {!! Form::textarea("otras_herramientas",null,["class"=>"form-control","id"=>"textarea","rows"=>"3","placeholder"=>"Otras habilidades/herramientas/conocimiento requeridos:"]); !!}
                                </div>
                ...
                <div class="row">
                    ...
                    <h3><p style="text-align: center;">EXPECTATIVAS @if(route('home') == "http://komatsu.t3rsc.co" || route('home') == "https://komatsu.t3rsc.co") <span>*</span> @endif </p></h3>
                    <hr>
                   
                    <div class="col-sm-12">
                        {!! Form::textarea("motivacion",null,["class"=>"form-control","id"=>"textarea","rows"=>"3","placeholder"=>"Motivación para participar en el proceso (por qué decidió participar?):"]); !!}
                    </div>
                    <p class="error text-danger direction-botones-center">{!! FuncionesGlobales::getErrorData("motivacion",$errors) !!}</p>
                    <div class="col-sm-12">
                        {!! Form::textarea("expectativas",null,["class"=>"form-control","id"=>"textarea","rows"=>"3","placeholder"=>"Expectativas para la reubicación laboral (qué espera de la compañía y del cargo?)"]); !!}
                    </div>
                    <p class="error text-danger direction-botones-center">{!! FuncionesGlobales::getErrorData("expectativas",$errors) !!}</p>
                </div>
                
                <!-- támpoco ereeeeeeeeeeeee---------------------->
                <div class="row">
                    <h3><p>OBSERVACIONES ADICIONALES</p></h3>
                    <hr>
                    
                    <div class="col-sm-12">
                     {!! Form::textarea("conflicto",null,["class"=>"form-control","id"=>"conflicto_txt","rows"=>"5","placeholder"=>"Conflicto de intereses.(tiene el candidato algún tipo de relación de parentesco -civil, afinidad o consanguinidad- con algún empleado o contratista, proveedor, cliente de la compañía; participación en la propiedad o gestión de un tercero)"]); !!}
                    ...
                    <div class="col-sm-12">
                     {!! Form::textarea("conflicto_entrevistador",null,["class"=>"form-control","id"=>"conflicto_txt_enrevistador","rows"=>"5","placeholder"=>"Tiene el entrevistador algún tipo de relación de parentesco -civil, afinidad o consanguinidad-, conoce o ha trabajado con el candidato entrevistado"]); !!}
                    </div>

                    <div class="col-sm-12">
                        {!! Form::textarea("comentarios_entrevistado",null,["class"=>"form-control","id"=>"textarea","rows"=>"3","placeholder"=>"Comentarios adicionales del entrevistado:"]); !!}
                    </div>
                    ...
                    <div class="col-sm-12">
                        {!! Form::textarea("comentarios_entrevistador",null,["class"=>"form-control","id"=>"textarea","rows"=>"3","placeholder"=>"Comentarios adicionales del entrevistador:"]); !!}
                    </div>
                ...
                <div class="col-md-12">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            <label for="trabajo-empresa-temporal" class="col-md-4 control-label">Apto: @if(route('home') == "http://komatsu.t3rsc.co" || route('home') == "https://komatsu.t3rsc.co")<span>*</span>@endif </label>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            <label for="trabajo-empresa-temporal" class="col-md-4 control-label">Continua proceso @if(route('home') == "http://komatsu.t3rsc.co" || route('home') == "https://komatsu.t3rsc.co") <span>*</span> @endif </label>
                       
                            <div class="col-md-8">
                                <label class="switchBtn">
                                    {!! Form::checkbox("continua",1,1,["class"=>"checkbox-preferencias si_no",'checked'=>true,"id"=>"switch"]) !!}
                                    <div class="slide"></div>
                                </label>
                            </div>
                        </div>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            <label for="trabajo-empresa-temporal" class="col-md-4 control-label">Tentativo: @if(route('home') == "http://komatsu.t3rsc.co" || route('home') == "https://komatsu.t3rsc.co") <span>*</span> @endif </label>
                            
                            <div class="col-md-8">
                                <label class="switchBtn">
                                    {!! Form::checkbox("tentativo",1,1,["class"=>"checkbox-preferencias si_no","id"=>"switch",'checked'=>true]) !!}
                                    <div class="slide"></div>
                                </label>
                            </div>
                        </div>
                ...
                <div class="form-group">
                    <label for="textarea" class="col-sm-4 control-label"> Justificacion
                        @if(route('home') == "http://komatsu.t3rsc.co" || route('home') == "https://komatsu.t3rsc.co") <span>*</span> @endif
                    </label>
             
                    <div class="col-sm-12">
                        {!! Form::textarea("justificacion",null,["class"=>"form-control","id"=>"justificacion","rows"=>"3"]); !!}
                    </div>
                </div>
    ...
    @elseif(route('home') == "https://demo.t3rsc.co" || route('home') == "http://demo.t3rsc.co" || route('home') == "https://nases.t3rsc.co" || route('home') == "http://nases.t3rsc.co" || route('home') == "http://localhost:8000" )

        {!! Form::model($proceso,["id"=>"fr_entrevista_semi"]) !!}
            
            {!! Form::hidden("ref_id",$ref_id) !!}
            {!! Form::hidden("req_id",$req_id) !!}
            {!! Form::hidden("user_id",$proceso->user_id) !!}
                ...
                <div class="row">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="col-sm-10">
                                {!! Form::text("nombre_candidato",$proceso->nombres." ".$proceso->primer_apellido." ".$proceso->segundo_apellido ,["class"=>"form-control","id"=>"nombre_candidato"]); !!}
                            </div>
                            <p class="error text-danger direction-botones-center">{!! FuncionesGlobales::getErrorData("aspecto_familiar",$errors) !!}</p>
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="col-sm-10">
                                {!! Form::number("numero_id",null,["class"=>"form-control","id"=>"numero_id"]); !!}
                            </div>
                            <p class="error text-danger direction-botones-center">{!! FuncionesGlobales::getErrorData("aspecto_familiar",$errors) !!}</p>
                        </div>
                    </div>
                    ...
                    <div class="row"> 
                        <div class="col-md-6">
                          <label for="inputEmail3" class="col-sm-12 control-label"> Edad</label>
                            <div class="col-sm-10">
                                {!! Form::number("edad",$proceso->edad,["class"=>"form-control","id"=>"edad","readonly"=>"readonly"]); !!}
                            </div>
                            <p class="error text-danger direction-botones-center">{!! FuncionesGlobales::getErrorData("aspecto_familiar",$errors) !!}</p>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="col-sm-10">
                                ...
                                <input type="hidden" name="pais_nacimiento" id="pais_nacimiento" value="{{$proceso->pais_nacimiento}}">
                                <input type="hidden" name="departamento_nacimiento" id="departamento_nacimiento" value="{{$proceso->departamento_nacimiento}}">
                                <input type="hidden" name="ciudad_nacimiento" id="ciudad_nacimiento" value="{{$proceso->ciudad_nacimiento}}">
                            </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="col-sm-10">
                                ...
                                <input type="hidden" name="pais_residencia" id="pais_residencia" value="{{$proceso->pais_residencia}}">
                                <input type="hidden" name="departamento_residencia" id="departamento_residencia" value="{{$proceso->departamento_residencia}}">
                                <input type="hidden" name="ciudad_residencia" id="ciudad_residencia" value="{{$proceso->ciudad_residencia}}">
                            </div>
                            <p class="error text-danger direction-botones-center">{!! FuncionesGlobales::getErrorData("aspecto_familiar",$errors) !!}</p>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <label for="barrio" class="col-sm-12 control-label">Barrio</label>
                            <div class="col-sm-10">
                        ...
                        <div class="col-md-6">
                            <label for="telefono_movil" class="col-sm-12 control-label">Celular</label>
                            <div class="col-sm-10">
                                {!! Form::number("telefono_movil",null,["class"=>"form-control","id"=>"telefono_movil"]); !!}
                            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="col-sm-10">
                                {!! Form::number("telefono_fijo",null,["class"=>"form-control","id"=>"telefono_fijo"]); !!}
                            </div>
                            <p class="error text-danger direction-botones-center">{!! FuncionesGlobales::getErrorData("aspecto_familiar",$errors) !!}</p>
                        </div>
                ...
                <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="col-sm-12">
                                {!! Form::textarea("observacion_familiar", null,["class"=>"form-control","id"=>"observacion_familiar",
                                    "rows"=>2]); !!}
                            </div>  
                            <p class="error text-danger direction-botones-center">{!! FuncionesGlobales::getErrorData("aspecto_familiar",$errors) !!}</p>
                        </div>
                ...
                <div class="row">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="col-sm-10">
                                ...
                                {!! Form::select("estado_civil",$estadoCivilSelect,null,["class"=>"form-control" ,"id"=>"estado_civil"]) !!}
                            </div>
                            <p class="error text-danger direction-botones-center">{!! FuncionesGlobales::getErrorData("aspecto_familiar",$errors) !!}</p>
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="col-sm-4">
                                {!! Form::number("numero_hijos", $hijos,["class"=>"form-control","id"=>"numero_hijos"]); !!}
                            </div>

                            <div class="col-sm-6">
                                {!! Form::textarea("observacion_hijos", null,[
                                    "class"=>"form-control",
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="col-sm-4">
                                {!! Form::select("militar_situacion",[""=>"Seleccionar","1"=>"Si","0"=>"No"],null,[
                                    "class"=>"form-control",
                                    "id"=>"militar_situacion"
                                ]) !!}
                            </div>

                            <div class="col-sm-6">
                                {!! Form::textarea("observacion_libreta", null,[
                                    "class"=>"form-control",
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="col-sm-10">
                                {!! Form::number("numero_libreta",null,["class"=>"form-control","id"=>"numero_libreta"]); !!}
                            </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="col-sm-10">
                                {!! Form::select("clase_libreta",$claseLibreta,null,["class"=>"form-control","id"=>"clase_libreta"]) !!}
                            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="col-sm-10">
                                @if($proceso->numero_licencia != '' && $proceso->categoria_licencia != '')
                                    Si <input type="radio" name="tiene_licencia" value="1" checked>
                                    No <input type="radio" name="tiene_licencia" value="0">
                                @elseif($proceso->numero_licencia == '' && $proceso->categoria_licencia == '')
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="col-sm-10">
                                {!! Form::number("numero_licencia",null,["class"=>"form-control","id"=>"numero_licencia"]); !!}
                            </div>
                            <p class="error text-danger direction-botones-center">{!! FuncionesGlobales::getErrorData("aspecto_familiar",$errors) !!}</p>
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="col-sm-10">
                                {!! Form::select("categoria_licencia",$categoriaLicencias, $proceso->categoria_licencia,["class"=>"form-control selectcategory","id"=>"categoria_licencia"])  !!}
                            </div>
                            <p class="error text-danger direction-botones-center">{!! FuncionesGlobales::getErrorData("aspecto_familiar",$errors) !!}</p>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="col-sm-10">
                                {!! Form::select("talla_camisa",$talla_camisa, $proceso->talla_camisa,["class"=>"form-control", "id"=>"talla_zapatos"]) !!}
                            </div>
                            <p class="error text-danger direction-botones-center">{!! FuncionesGlobales::getErrorData("aspecto_familiar",$errors) !!}</p>
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="col-sm-10">
                                {!! Form::select("talla_pantalon",$talla_pantalon,$proceso->talla_pantalon,["class"=>"form-control", "id"=>"talla_zapatos"]) !!}
                            </div>
                            <p class="error text-danger direction-botones-center">{!! FuncionesGlobales::getErrorData("aspecto_familiar",$errors) !!}</p>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="col-sm-10">
                                {!! Form::select("talla_zapatos",$talla_zapatos,$proceso->talla_zapatos,["class"=>"form-control", "id"=>"talla_zapatos"]) !!}
                            </div>
                            <p class="error text-danger direction-botones-center">{!! FuncionesGlobales::getErrorData("aspecto_familiar",$errors) !!}</p>
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="col-sm-10">
                                {!! Form::select("entidad_eps",$entidadesEps,$proceso->entidad_eps,["class"=>"form-control","id"=>"entidad_eps"]) !!}
                            </div>
                            <p class="error text-danger direction-botones-center">{!! FuncionesGlobales::getErrorData("aspecto_familiar",$errors) !!}</p>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="col-sm-12">
                                {!! Form::textarea("observacion_estudios", null,["class"=>"form-control","id"=>"observacion_estudios",
                                    "rows"=>2]); !!}
                            </div>
                            <p class="error text-danger direction-botones-center">{!! FuncionesGlobales::getErrorData("aspecto_familiar",$errors) !!}</p>
                        </div>
                ...
                <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="col-sm-12">
                                {!! Form::textarea("observacion_experiencia", null,["class"=>"form-control","id"=>"observacion_experiencia",
                                    "rows"=>2]); !!}
                            </div>  
                            <p class="error text-danger direction-botones-center">{!! FuncionesGlobales::getErrorData("aspecto_familiar",$errors) !!}</p>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="col-sm-12">
                                        {!! Form::textarea("pregunta_validacion_1", null,["class"=>"form-control","id"=>"pregunta_validacion_1","rows"=>1]); !!}
                                    </div>
                                    <p class="error text-danger direction-botones-center">{!! FuncionesGlobales::getErrorData("aspecto_familiar",$errors) !!}</p>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="col-sm-12">
                                        {!! Form::textarea("pregunta_validacion_2", null,["class"=>"form-control","id"=>"pregunta_validacion_2","rows"=>1]); !!}
                                    </div>
                                    <p class="error text-danger direction-botones-center">{!! FuncionesGlobales::getErrorData("aspecto_familiar",$errors) !!}</p>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="col-sm-12">
                                        {!! Form::textarea("pregunta_validacion_3", null,["class"=>"form-control","id"=>"pregunta_validacion_3","rows"=>1]); !!}
                                    </div>
                                    <p class="error text-danger direction-botones-center">{!! FuncionesGlobales::getErrorData("aspecto_familiar",$errors) !!}</p>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="col-sm-12">
                                        {!! Form::textarea("pregunta_validacion_4", null,["class"=>"form-control","id"=>"pregunta_validacion_4","rows"=>1]); !!}
                                    </div>
                                    <p class="error text-danger direction-botones-center">{!! FuncionesGlobales::getErrorData("aspecto_familiar",$errors) !!}</p>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="col-sm-12">
                                        <label for="pregunta_validacion_5" id="label_pregunta_validacion_5" class="control-label">¿ Tiene tatuajes ? *</label>

                                        Si <input type="radio" name="pregunta_validacion_5" id="pregunta_validacion_5" value="1">
                                        No <input type="radio" name="pregunta_validacion_5" id="pregunta_validacion_5" value="0">
                                    </div>
                                    <p class="error text-danger direction-botones-center">{!! FuncionesGlobales::getErrorData("aspecto_familiar",$errors) !!}</p>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="col-sm-12">
                                        <label for="cargo" id="label_pregunta_validacion_6" class="control-label">¿ Tiene o necesita gafas ? *</label>

                                        Si <input type="radio" name="pregunta_validacion_6" id="pregunta_validacion_6" value="1">
                                        No <input type="radio" name="pregunta_validacion_6" id="pregunta_validacion_6" value="0">
                                    </div>
                                    <p class="error text-danger direction-botones-center">{!! FuncionesGlobales::getErrorData("aspecto_familiar",$errors) !!}</p>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="col-sm-12">
                                        <label for="cargo" id="label_pregunta_validacion_7" class="control-label">¿ Disponibilidad para viajar ? *</label>

                                        Si <input type="radio" name="pregunta_validacion_7" id="pregunta_validacion_7" value="1">
                                        No <input type="radio" name="pregunta_validacion_7" id="pregunta_validacion_7" value="0">
                                    </div>
                                    <p class="error text-danger direction-botones-center">{!! FuncionesGlobales::getErrorData("aspecto_familiar",$errors) !!}</p>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="col-sm-12">
                                        <label for="pregunta_validacion_8" id="label_pregunta_validacion_8" class="control-label">¿ Multas o comparendos ? *</label>

                                        Si <input type="radio" name="pregunta_validacion_8" id="pregunta_validacion_8" value="1">
                                        No <input type="radio" name="pregunta_validacion_8" id="pregunta_validacion_8" value="0">
                                    </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="col-sm-12">
                                        <label for="pregunta_validacion_9" id="label_pregunta_validacion_9" class="control-label">¿ Reportes en datacredito o centrales de riesgo ? *</label>

                                        Si <input type="radio" name="pregunta_validacion_9" id="pregunta_validacion_9" value="1">
                                        No <input type="radio" name="pregunta_validacion_9" id="pregunta_validacion_9" value="0">
                                    </div>

                                    <br><br>

                                    <label for="valor_reporte" class="col-sm-8 control-label" id="campo_reporte">
                                        Valor
                                        {!! Form::number("valor_reporte",null,["class"=>"form-control","id"=>"valor_reporte"]); !!}
                                    </label>
                                ...
                                <div class="col-md-6">
                                    <div class="col-sm-12">
                                        <label for="pregunta_validacion_10" id="label_pregunta_validacion_10" class="control-label">¿ Ya trabajó en Nases ? *</label>

                                        Si <input type="radio" name="pregunta_validacion_10" id="pregunta_validacion_10" value="1">
                                        No <input type="radio" name="pregunta_validacion_10" id="pregunta_validacion_10" value="0">
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-md-1"></div>
                                <div class="col-md-10">
                                    <p id="label_autorizacion" style="text-align: center;">
                                ...
                                <div class="col-sm-12" style="text-align: center;">
                                    Si <input type="radio" name="autorizacion" id="autorizacion" value="1" checked="">
                                    No <input type="radio" name="autorizacion" id="autorizacion" value="0">
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="col-sm-12">
                                        {!! Form::textarea("observacion_preguntas", null,["class"=>"form-control","id"=>"observacion_preguntas",
                                            "rows"=>2]); !!}
                                    </div>  
                                    <p class="error text-danger direction-botones-center">{!! FuncionesGlobales::getErrorData("aspecto_familiar",$errors) !!}</p>
                                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <label for="cargo" class="col-sm-12 control-label">¿ Cuál ha sido su mayor logro ? *</label>
                                    <div class="col-sm-12">
                                        {!! Form::textarea("pregunta_validacion_1", $preg_val->respuesta_1,["class"=>"form-control","id"=>"pregunta_validacion_1","rows"=>1]); !!}
                                    </div>
                                    <p class="error text-danger direction-botones-center">{!! FuncionesGlobales::getErrorData("aspecto_familiar",$errors) !!}</p>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <label for="cargo" class="col-sm-12 control-label">¿ Qué lo motiva a trabajar ? *</label>
                                    <div class="col-sm-12">
                                        {!! Form::textarea("pregunta_validacion_2", $preg_val->respuesta_2,["class"=>"form-control","id"=>"pregunta_validacion_2","rows"=>1]); !!}
                                    </div>
                                    <p class="error text-danger direction-botones-center">{!! FuncionesGlobales::getErrorData("aspecto_familiar",$errors) !!}</p>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <label for="cargo" class="col-sm-12 control-label">¿ Cuáles son sus metas ? *</label>
                                    <div class="col-sm-12">
                                        {!! Form::textarea("pregunta_validacion_3", $preg_val->respuesta_3,["class"=>"form-control","id"=>"pregunta_validacion_3","rows"=>1]); !!}
                                    </div>
                                    <p class="error text-danger direction-botones-center">{!! FuncionesGlobales::getErrorData("aspecto_familiar",$errors) !!}</p>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <label for="cargo" class="col-sm-12 control-label">¿ Qué actividades hace en su tiempo libre ? *</label>
                                    <div class="col-sm-12">
                                        {!! Form::textarea("pregunta_validacion_4", $preg_val->respuesta_4,["class"=>"form-control","id"=>"pregunta_validacion_4","rows"=>1]); !!}
                                    </div>
                                    <p class="error text-danger direction-botones-center">{!! FuncionesGlobales::getErrorData("aspecto_familiar",$errors) !!}</p>
                                </div>
            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <table class="table table-bordered tbl_info">
                        ...
                        <tr>
                            <td>
                                <p id="label_concepto_final_preg_1">¿ El candidato posee las competencias para ejercer el cargo ? *</p>
                            </td>
                            <td>
                                Si <input type="radio" name="concepto_final_preg_1" id="concepto_final_preg_1" value="1">
                            </td>
                            <td>
                                No <input type="radio" name="concepto_final_preg_1" id="concepto_final_preg_1" value="0">
                            </td>
                        </tr>

                        <tr>
                            <td>
                                <p id="label_concepto_final_preg_2">¿ El candidato cuenta con la experiencia necesaria ? *</p>
                            </td>
                            <td>
                                Si <input type="radio" name="concepto_final_preg_2" id="concepto_final_preg_2" value="1">
                            </td>
                            <td>
                                No <input type="radio" name="concepto_final_preg_2" id="concepto_final_preg_2" value="0">
                            </td>
                        </tr>

                        <tr>
                            <td>
                                <p id="label_concepto_final_preg_3">¿ El candidato cuenta con algún tipo de reporte o restricción que le impida ejercer el cargo ? *</p>
                            </td>
                            <td>
                                Si <input type="radio" name="concepto_final_preg_3" id="concepto_final_preg_3" value="1">
                            </td>
                            <td>
                                No <input type="radio" name="concepto_final_preg_3" id="concepto_final_preg_3" value="0">
                            </td>
                        </tr>
                    ...
                    <div class="row">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="col-sm-12">
                                    {!! Form::textarea("concepto_final", null,["class"=>"form-control","id"=>"concepto_final",
                                        "rows"=>2]); !!}
                                </div>
                        ...
                        <div class="col-sm-12">
                            <label for="apto" id="label_apto" class="control-label">¿ El candidato es apto para el cargo ? *</label>

                            Si <input type="radio" name="apto" id="apto" value="1">
                            No <input type="radio" name="apto" id="apto" value="0">
                        </div>
        ...
        {!! Form::model(Request::all(),["id"=>"fr_entrevista_semi"]) !!}
                                ...
                                <div class="row">
                                    ...
                                    @else
                                        ...
                                        <div class="col-md-6">
                                            <label for="inputEmail3" class="col-sm-4 control-label"> Fecha retiro</label>
                                            <div class="col-sm-7">
                                                {!! Form::text("fecha_reriro",$trabajo,["class"=>"form-control","id"=>"fecha_reriro","readonly"=>"readonly"]); !!}
                                            </div>
                                            <p class="error text-danger direction-botones-center">{!! FuncionesGlobales::getErrorData("aspecto_familiar",$errors) !!}</p>
                                        </di=v>
            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-sm-12">
                        {!! Form::textarea("fortalezas",null,["class"=>"form-control","id"=>"textarea","rows"=>"1"]); !!}
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12">
                        {!! Form::textarea("opor_mejora",null,["class"=>"form-control","id"=>"textarea","rows"=>"1"]); !!}
                    </div>
                    <p class="error text-danger direction-botones-center">{!! FuncionesGlobales::getErrorData("especificaciones_cargo",$errors) !!}</p></div>
                </div>
                 <div class="row">
                    ...
                    <div class="col-sm-12">
                        {!! Form::textarea("proyectos",null,["class"=>"form-control","id"=>"textarea","rows"=>"1"]); !!}
                    </div>
                    <p class="error text-danger direction-botones-center">{!! FuncionesGlobales::getErrorData("especificaciones_cargo",$errors) !!}</p></div>
                </div>
                 <div class="row">
                    ...
                    <div class="col-sm-12">
                        {!! Form::textarea("valores",null,["class"=>"form-control","id"=>"textarea","rows"=>"1"]); !!}
                    </div>
                    <p class="error text-danger direction-botones-center">{!! FuncionesGlobales::getErrorData("especificaciones_cargo",$errors) !!}</p></div>
                </div>
                 <div class="row">
                    ...
                    <div class="col-sm-12">
                     {!! Form::textarea("candidato_idoneo",null,["class"=>"form-control","id"=>"textarea","rows"=>"1"]); !!}
                    </div>
                ...
                <div class="row">
                 <div class="col-md-12">
                    ...
                    <div class="col-sm-12">
                        {!! Form::textarea("otros_trabajos",null,["class"=>"form-control","id"=>"textarea","rows"=>"3"]); !!}
                    </div>
                    <p class="error text-danger direpction-botones-center">{!! FuncionesGlobales::getErrorData("otros_trabajos",$errors) !!}</p></div>
                </div>
                 <div class="row">
                    <div class="col-md-12">
                   <h3><p style="text-align: center;">Concepto de la entrevista</p></h3>
                    ...
                    <div class="col-sm-12">
                        {!! Form::textarea("concepto_entre",null,["class"=>"form-control","id"=>"textarea","rows"=>"3"]); !!}
                    </div>
                    <p class="error text-danger direction-botones-center">{!! FuncionesGlobales::getErrorData("especificaciones_cargo",$errors) !!}</p>
                </div>
            </div>
