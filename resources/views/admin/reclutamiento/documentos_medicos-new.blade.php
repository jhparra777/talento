...
@section('contenedor')
    ...
    {!! Form::model(Request::all(), ["id" => "examenes_medicos", "method" => "GET"]) !!}
        <div class="row">
                            ...
                            <tbody>
                                @foreach($candidatos as $candidato)
                                    <tr>
                                        ...
                                        <td>
                                            <a class="btn btn-default btn-sm | tri-br-2 tri-txt-purple tri-bg-white tri-bd-purple tri-transition-200 tri-hover-out-purple"  href="{{ route('admin.gestionar_documentos_medicos', ['ref_id' => $candidato->ref_id]) }}">
                                                Gestionar
                                            </a>
                                        </td>
                                    </tr>
                            ...
                            <tbody>
                                @foreach($candidatos as $candidato)
                                    <tr>
                                        ...
                                        <td>{{ $candidato->created_at }}</td>
                                        <td>
                                            <a class="btn btn-default btn-sm | tri-br-2 tri-txt-purple tri-bg-white tri-bd-purple tri-transition-200 tri-hover-out-purple"  href="{{ route('admin.gestionar_documentos_medicos', ['ref_id' => $candidato->orden]) }}">
                                                Gestionar
                                            </a>
                                        </td>
                                    </tr>
