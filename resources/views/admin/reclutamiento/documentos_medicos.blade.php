...
@section('contenedor')
    <h3>Candidatos exámenes médicos</h3>
    ...
    {!! Form::model(Request::all(), ["id" => "examenes_medicos", "method" => "GET"]) !!}
        ...
        <a class="btn btn-warning" href="{{route("admin.examenes_medicos")}}" >Limpiar</a>
                        ...
                        <tr>
                            <td>
                                {!! Form::checkbox("ref_id[]", $candidato->ref_id, null, [
                                    "data-url" => route('admin.gestionar_documentos_medicos', ["ref_id" => $candidato->ref_id])
                                ]) !!}
                            </td>
            ...
            <table class="table table-bordered">
                ...
                <tbody>
                    ...
                    @foreach($candidatos as $candidato)
                        <tr>
                            <td>
                                {!! Form::checkbox("ref_id[]", $candidato->orden, null, [
                                    "data-url" => route('admin.gestionar_documentos_medicos', ["ref_id" => $candidato->orden])
                                ]) !!}
                            </td>
