...
@section("contenedor")
    ...
    <div class="row">
        ...
        <div class="col-md-12 mb-2">
            <h3>Detalle prueba digitación</h3>

            <ul class="list-unstyled mt-2">
                <li>
                    <h4>
                        <i class="fa fa-angle-double-right" aria-hidden="true"></i> <b>Requerimiento - Cliente:</b> {{ $candidato_digitacion->req_id }} - {{ $requerimiento_detalle->nombre_cliente_req() }}
                    </h4>
                </li>
                ...
                <li>
                    <h4>
                        <i class="fa fa-angle-double-right" aria-hidden="true"></i> <b>Nombre:</b> {{ $candidato_digitacion->nombre_completo }}
                    </h4>
                </li>
            </ul>
        </div>
        ...
        @if($candidato_digitacion->estado == 1)
            {{-- Botón informe --}}
            <div class="col-md-12 text-right mb-2">
                <a href="{{ route('admin.prueba_digitacion_informe', [$candidato_digitacion->id]) }}" target="_blank" class="btn btn-primary">
    ...
    @if($candidato_digitacion->estado == 1)
            ...
            <div class="panel panel-default">
                <div class="panel-body">
                    <div class="col-md-12 text-center mb-2">
                        <h4>Comparación resultados esperados</h4>
                    </div>

                    <div class="col-md-6 text-center">
                        <h4><b>{{ $configuracion->ppm_esperada }} PPM</b> (esperada) | <b>{{ $candidato_digitacion->ppm }} PPM</b> (candidato/a)</h4>
                    </div>

                    <div class="col-md-6 text-center">
                        <h4><b>{{ $configuracion->precision_esperada }}%</b> (esperada) | <b>{{ $candidato_digitacion->precision_user }}%</b> (candidato/a)</h4>
                    </div>
                </div>
            </div>
        @endif
        ...
        {{-- Panel resultados --}}
        @include('admin.reclutamiento.pruebas.digitacion.includes._panel_digitacion_resultados_admin')
                                ...
                                <div class="owl-carousel">
                                    @foreach($digitacion_fotos as $foto)
                                        <div class="text-center">
                                            ...
                                            <a class="mt-2" href="{{ asset("recursos_prueba_digitacion/prueba_digitacion_$candidato_digitacion->user_id_$candidato_digitacion->req_id_$candidato_digitacion->id/$foto->descripcion") }}" target="_blank">Ver completa</a>
                                        </div>
                                    @endforeach
                                </div>
                            @else
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title" id="modalConceptoLabel">Concepto final Digitación</h4>
                    </div>
                    <div class="modal-body">
                        ...
                        <form id="frmConceptoFinal" data-smk-icon="glyphicon-remove-sign">
                            ...
                            {!! Form::hidden('digitacion_id', $candidato_digitacion->id) !!}
                            {!! Form::hidden('candidato_digitacion', $candidato_digitacion->user_id) !!}
                        </form>
                    </div>
            ...
            document.querySelector('#guardarConcepto').addEventListener('click', () => {
                if ($('#frmConceptoFinal').smkValidate()) {
                    $.ajax({
                        ...
                        url: "{{ route('admin.prueba_digitacion_concepto_final') }}",
