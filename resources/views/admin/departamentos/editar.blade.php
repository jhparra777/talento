...
<div class="col-md-10 col-md-offset-1">
    {!! Form::model($registro,["id"=>"fr_departamentos","route"=>"admin.departamentos.actualizar","method"=>"POST"]) !!}
    {!! Form::hidden("id") !!}
    ...
    {!! FuncionesGlobales::valida_boton_req("admin.departamentos.actualizar","Actualizar","submit","btn btn-success") !!}
