...
<div class="col-md-8 col-md-offset-2">
    {!! Form::model($registro,["id"=>"fr_generos","route"=>"admin.generos.actualizar","method"=>"POST"]) !!}
    {!! Form::hidden("id") !!}
    ...
    {!! FuncionesGlobales::valida_boton_req("admin.generos.actualizar","Actualizar","submit","btn btn-success") !!}
