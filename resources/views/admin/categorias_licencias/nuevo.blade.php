...
<div class="col-md-8 col-md-offset-2">
    {!! Form::open(["id"=>"fr_categorias_licencias","route"=>"admin.categorias_licencias.guardar","method"=>"POST"]) !!}
    {!! Form::hidden("active",1,["class"=>"form-control","placeholder"=>"active" ]); !!}

    <h3>Nuevo   Categorias Licencias</h3>
...
<div class="col-md-12 form-group">
    ...
    {!! FuncionesGlobales::valida_boton_req("admin.categorias_licencias.guardar","Guardar","submit","btn btn-success") !!}
