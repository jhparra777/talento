...
<div class="col-md-8 col-md-offset-2">
    {!! Form::model($registro,["id"=>"fr_fuentes_publicidad","route"=>"admin.fuentes_publicidad.actualizar","method"=>"POST"]) !!}
    {!! Form::hidden("id") !!}

    <h3>Editar Fuentes Publicidad</h3>
    ...
    {!! FuncionesGlobales::valida_boton_req("admin.fuentes_publicidad.actualizar","Actualizar","submit","btn btn-success") !!}
