...
<div class="col-md-8 col-md-offset-2">
    {!! Form::open(["id"=>"fr_fuentes_publicidad","route"=>"admin.fuentes_publicidad.guardar","method"=>"POST"]) !!}


    <h3>Nuevo   Fuentes Publicidad</h3>
    ...
    {!! FuncionesGlobales::valida_boton_req("admin.fuentes_publicidad.guardar","Guardar","submit","btn btn-success") !!}
