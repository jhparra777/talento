...
<div class="col-md-8 col-md-offset-2">
    {!! Form::open(["id"=>"fr_estados_civiles","route"=>"admin.estados_civiles.guardar","method"=>"POST"]) !!}


    <h3>Nuevo   Estados Civiles</h3>
    ...
    {!! FuncionesGlobales::valida_boton_req("admin.estados_civiles.guardar","Guardar","submit","btn btn-success") !!}
