...
<div class="col-md-8 col-md-offset-2">
    {!! Form::model($registro,["id"=>"fr_estados_civiles","route"=>"admin.estados_civiles.actualizar","method"=>"POST"]) !!}
    {!! Form::hidden("id") !!}

    <h3>Editar Estados Civiles</h3>
    ...
    {!! FuncionesGlobales::valida_boton_req("admin.estados_civiles.actualizar","Actualizar","submit","btn btn-success") !!}
