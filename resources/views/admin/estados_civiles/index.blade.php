...
<h3>Lista de Estados Civiles</h3>
...
@endif
{!! Form::model(Request::all(),["id"=>"admin.estados_civiles.index","method"=>"GET"]) !!}
...
<a class="btn btn-warning" href="{{route("admin.estados_civiles.index")}}" >Limpiar</a>
{!! FuncionesGlobales::valida_boton_req("admin.estados_civiles.editar","Editar ","link","btn btn-warning",'onclick="return conf_registro(\'id[]\', this)"') !!}
{!! FuncionesGlobales::valida_boton_req("admin.estados_civiles.nuevo","Nuevo ","link","btn btn-info") !!}
...
<table class="table table-bordered">
    ...
    <tbody>
        ...
        <tr>
            <td>{!! Form::checkbox("id[]",$lista->id,null,["data-url"=>route('admin.estados_civiles.editar',["id"=>$lista->id])]) !!}</td>
