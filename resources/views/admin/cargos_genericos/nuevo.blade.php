...
<div class="col-md-8 col-md-offset-2">
    {!! Form::open(["id"=>"fr_cargos_genericos","route"=>"admin.cargos_genericos.guardar","method"=>"POST"]) !!}
    {!! Form::hidden("estado",1,["class"=>"form-control","placeholder"=>"estado" ]); !!}

    <h3>Nuevo   Cargo Genéricos</h3>
    ...
    <div class="row">
        ...
        <div class="col-md-12 form-group">
            <label for="inputEmail3" class="col-sm-2 control-label">Nombre del Cargo:</label>
            <div class="col-sm-10">
    ...
    {!! FuncionesGlobales::valida_boton_req("admin.cargos_genericos.guardar","Guardar","submit","btn btn-success") !!}
