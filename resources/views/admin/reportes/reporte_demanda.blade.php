...
@section('contenedor')
    <h3>
        <i aria-hidden="true" class="fa fa-file-text-o"></i>Reporte Ministerio-Demanda
    </h3>
    
    <hr/>

    {!! Form::model(Request::all(),["route"=>"admin.reportes_demanda","method"=>"GET","accept-charset"=>"UTF-8"]) !!}
    ...
    @if(isset($data))
        @include('admin.reportes.includes.grilla_detalle_demanda')
    @endif
    ...
    <script>
        $(function () {
            ...
            $('#export_excel_btn').click(function(e){
                ...
                $(this).prop("href","{{ route('admin.reportes.reportes_detalles_demanda_excel') }}?"+$data_form+"&formato=xlsx&fecha_inicio="+$fecha_inicio+"&fecha_final="+$fecha_final+"&cliente_id="+$cliente_id+"&criterio="+$criterio);
            });
            ...
            $('#export_pdf_btn').click(function(e){
                ...
                $(this).prop("href","{{ route('admin.reportes.reportes_detalles_demanda_excel') }}?"+$data_form+"&formato=pdf&fecha_inicio="+$fecha_inicio+"&fecha_final="+$fecha_final+"&cliente_id="+$cliente_id+"&criterio="+$criterio);
            });
        })
</script>
@stop
