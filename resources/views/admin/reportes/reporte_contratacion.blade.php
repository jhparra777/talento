...
<h3>
    ...
    Reportes Detalle Contratación
</h3>
<hr/>
{!! Form::model(Request::all(),["route"=>"admin.reportes_contratacion","method"=>"GET","accept-charset"=>"UTF-8"]) !!}
...
@if(isset($data))
   @include('admin.reportes.includes.grilla_detalle_contratacion')
@endif
...
<script>
    $(function () {
      ...
      $('#export_excel_btn').click(function(e){
          ...
          $req_id=$("#req_id").val();
          $agencia=$("#agencia").val();
          $(this).prop("href","{{ route('admin.reportes.reportes_detalles_contratacion_excel') }}?"+$data_form+"&formato=xlsx&fecha_inicio="+$fecha_inicio+"&fecha_final="+$fecha_final+"&cliente_id="+$cliente_id+"&req_id="+$req_id+"&agencia="+$agencia);
      });
      $('#export_pdf_btn').click(function(e){
          ...
          $req_id=$("#req_id").val();
           $agencia=$("#agencia").val();
          $(this).prop("href","{{ route('admin.reportes.reportes_detalles_contratacion_excel') }}?"+$data_form+"&formato=pdf&cliente_id="+$cliente_id+"&req_id="+$req_id+"&agencia="+$agencia);
      });
    })
</script>
@stop
