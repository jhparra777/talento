...
@section('contenedor')
<h3><i class="fa fa-line-chart" aria-hidden="true"></i> Indicador tipo proceso</h3>
<hr/>
<div class="container">
  <div class="jumbotron" style="background: #f5f5f5;">
    <h3>Información:</h3>
    <p>Este indicador mostrará los porcentajes por tipo de proceso de todas las vacantes que coincidan con los filtros especificados.</p>
</div>
</div>
{!! Form::model(Request::all(),["route"=>"admin.reporte.indicador_tipo_proceso","method"=>"GET","accept-charset"=>"UTF-8"]) !!}
...
<div class="col-md-6 form-group">
   <label for="inputEmail3" class="col-sm-4 control-label">Usuarios creación:</label>
   <div class="col-sm-8">
...
<div class="col-sm-12  text-center">
    <button type="submit" class="btn btn-success">Generar</button>
     @if(!isset($no_search))
        <a class="btn btn-info" href="{{route("admin.reporte.indicador_tipo_proceso")}}">Limpiar</a>
    @else
            ...
            <div class="row">
                <div class="col-md-8 col-md-offset-2">
                    <table class="table table-bordered table-striped">
                        <caption class="text-center"> Requerimientos por tipo de proceso</caption>
                        <thead>
                            <tr>
                        ...
                        <tbody>
                            @foreach($tipos_procesos as $tipo)
                                <tr>
                                    ...
                                    <td class="text-center">{{$array_procesos[$tipo->id]['cantidad']}}</td>
                                    <td class="text-center">{{$array_procesos[$tipo->id]['avg']}}</td>
                                </tr>
                            @endforeach
                            {{--<tr>
