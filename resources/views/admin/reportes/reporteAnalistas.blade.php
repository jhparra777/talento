...
@section('contenedor')
  ...
  {!! Form::model(Request::all(),["route"=>"admin.reportes_analistas","method"=>"GET","accept-charset"=>"UTF-8"]) !!}
  ...
  @if(isset($data))
    @include('admin.reportes.includes.grilla_detalle_analistas')
  @endif
  ...
  <script>
      $(function () {
        ...
        $('#export_excel_btn').click(function(e){
            ...
            $(this).prop("href","{{ route('admin.reportes.reportes_analistas_excel') }}?"+$data_form+"&formato=xlsx&fecha_inicio="+$fecha_inicio+"&fecha_final="+$fecha_final+"&cliente_id="+$cliente_id+"&criterio="+$criterio);
        });
        $('#export_pdf_btn').click(function(e){
            ...
            $(this).prop("href","{{ route('admin.reportes.reportes_analistas_excel') }}?"+$data_form+"&formato=pdf&fecha_inicio="+$fecha_inicio+"&fecha_final="+$fecha_final+"&cliente_id="+$cliente_id+"&criterio="+$criterio);
        });
      })
  </script>
@stop
