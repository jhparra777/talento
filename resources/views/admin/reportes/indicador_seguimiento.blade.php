...
@section('contenedor')
<h3><i class="fa fa-line-chart" aria-hidden="true"></i> Indicador seguimiento 1 a 1</h3>
<hr/>
<div class="container">
  <div class="jumbotron" style="background: #f5f5f5;">
    <h3>Información:</h3>
    <p>Este indicador mostrará el contraste de las cantidades de candidatos en cada estado o proceso, de acuerdo con la coincidencia de los filtros de búsqueda</p>
</div>
</div>
{!! Form::model(Request::all(),["route"=>"admin.reporte.indicador_seguimiento","method"=>"GET","accept-charset"=>"UTF-8"]) !!}
...
<div class="col-sm-12  text-center">
    <button type="submit" class="btn btn-success">Generar</button>
     @if(!isset($no_search))
        <a class="btn btn-info" href="{{route("admin.reporte.indicador_seguimiento")}}">Limpiar</a>
    @else
            ...
            <div class="row">
                <div class="col-md-8 col-md-offset-2">
                    <table class="table table-bordered table-striped">
                        {{--<caption class="text-center"> Datos acumulados</caption>
                        <thead>
                            <tr>
                ...
                <div class="col-md-8 col-md-offset-2">
                    @if(isset($report_barras))
                    <div id="pos_graph">       
                    </div>
                    {!! \Lava::render('BarChart', $report_barras, 'pos_graph') !!}
                    @endif
                </div>
