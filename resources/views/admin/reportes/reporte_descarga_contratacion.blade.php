...
<h3>
    ...
    Reportes Descarga-Contratación
</h3>
<hr/>
{!! Form::model(Request::all(),["route"=>"admin.reportes_descarga_contratacion","method"=>"GET","accept-charset"=>"UTF-8"]) !!}
...
@if(isset($data))
   @include('admin.reportes.includes.grilla_detalle_descarga_contratacion')
@endif
...
<script>
    $(function () {
      ...
      $('#export_excel_btn').click(function(e){
          ...
          $(this).prop("href","{{ route('admin.reportes_detalles_descarga_contratacion_excel') }}?"+$data_form+"&formato=xlsx&fecha_inicio="+$fecha_inicio+"&fecha_final="+$fecha_final+"&cliente_id="+$cliente_id+"&criterio="+$criterio);
      });
