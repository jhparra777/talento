...
@section('contenedor')
  <h3>
   <i aria-hidden="true" class="fa fa-file-text-o"></i>
    Reportes Detalle Requerimientos
  </h3>
  
  <hr/>

  {!! Form::model(Request::all(),["route"=>"admin.reportes_detalles","method"=>"GET","accept-charset"=>"UTF-8","id"=>"reportes"]) !!}
     ...
     $('#cliente_id').on("change", function (e) {
      ...
      $('#ciudad_autocomplete').autocomplete({
        ...
        $('#export_excel_btn').click(function(e){
            ...
            $(this).prop("href","{{route('admin.reportes.reportes_detalles_excel')}}?"+$data_form+"&formato=xlsx&fecha_inicio="+$fecha_inicio+"&fecha_final="+$fecha_final+"&cliente_id="+$cliente_id+"&criterio="+$criterio+"&usuario_gestion="+$usuario_gestion);
             // $("#reportes").submit();
               //$data_form.submit();
        });
