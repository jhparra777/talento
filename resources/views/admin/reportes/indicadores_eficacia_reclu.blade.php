...
<hr/>
{!! Form::model(Request::all(),["route"=>"admin.reporte.indicadores_eficacia_reclu","method"=>"GET","accept-charset"=>"UTF-8"]) !!}
            ...
            <table class="table table-bordered">
                <thead>
                    <tr>
                        ...
                        <th style="text-align: center;"># Candidatos Aptos</th>
                    </tr>
                </thead>
                <tbody>
                    <tr>

                        @if($eficacia1['total_asistieron'] == 1)
                        ...
                        <td style="text-align: center;">{{ $eficacia1['total_aptos'] }}</td>
                    </tr>
