                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td class="m_-7484884227191431181m_-8044308263189181155fs13" style="font-size:14px;line-height:20px;padding-top:10px;padding-right:30px;padding-bottom:10px;padding-left:30px;text-align:left;color:#353e4a">
                                                    ...
                                                    <p>En nombre de la compañía queremos agradecerle su interés en el proceso de selección adelantado para el cargo de {{$requerimiento->getCargoEspecifico()->descripcion}}</p>

                                                    <p>Si bien por las necesidades específicas de este proceso no fue seleccionado, estamos seguros que por sus competencias podemos contar con usted en futuros procesos.</p>
