...
<div class="modal-body">
    {!! Form::model(Request::all(),["route"=>(!empty($datos["id"]))?"admin.actualizar_candidato_fuente":"admin.guardar_candidato_fuente","id"=>"fr_editar_proveedor"]) !!}
                    {{csrf_field()}}
        ...
        <div class="col-md-12 form-group">
            ...
            <div class="col-sm-10">
              {!! Form::text("telefono",$proveedor->telefono,["class"=>"form-control solo-numero" ]); !!}
            </div>
            ...
            <div class="col-md-12 form-group">
                ...
                <div class="col-sm-10">
                   {!! Form::textarea("direccion",$proveedor->direccion,["class"=>"form-control","id"=>"textarea","rows"=>"1"]); !!}
                </div>
...
<div class="modal-footer">
    ...
    <button type="button" class="btn btn-success" id="confirmar_editar_proveedor" >Confirmar</button>
</div>