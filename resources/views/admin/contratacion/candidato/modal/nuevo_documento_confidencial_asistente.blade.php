...
<div class="modal-body">
	{!! Form::model(Request::all(), ["id" => "fr_nuevo_documento_contratacion", "files" => true, "data-smk-icon" => "glyphicon glyphicon-remove"]) !!}
        ...
        <div class="modal-footer">
            ...
            <button type="button" class="btn btn-success | tri-px-2 tri-br-2 tri-border--none tri-transition-300 tri-green"  id="guardar_nuevo_doc_conf">Guardar</button>
        </div>
    {!! Form::close() !!}
    ...
    <script>
        $(function(){
        	...
        	$("#guardar_nuevo_doc_conf").on("click", function(){
                if ($('#fr_nuevo_documento_contratacion').smkValidate()){
                    ...
                    $.ajax({
                        url: "{{route('admin.guardar_documento_asistente_confidencial')}}",
                        type: "post",
                        dataType: "html",
                        data: formData,
                        cache: false,
