...
$(function () {
    ...
    <body>
                    ...
                    <nav class="navbar navbar-default">
                        <div class="container-fluid">
                            ...
                            <div class="navbar-header">
                                ...
                                <img class=""  src="{{url('img/Logo_Enlace.svg')}}" style="width: 200px;margin-top: 20px"/></a>
                            </div>

                            <!-- Collect the nav links, forms, and other content for toggling -->
                            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">

                                <ul class="nav navbar-nav navbar-right user_login">

                                    <li class="dropdown">
                                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><i class="fa fa-user icon-top-nav"></i> Hola, {{$user->name}}&nbsp; <span class="caret"></span></a>
                                        <ul class="dropdown-menu">
                                            <li><a href="{{route("admin.cambiar_contrasena")}}">Cambiar Contraseña</a></li>
        ...
        <div class="container-fluid">
            <ul class="breadcrumb"><li>Inicio</li>{!!  FuncionesGlobales::migaPan();!!}</ul>
            @yield("contenedor")
        </div>
        <footer >
            @include('footer_all')
