...
<body>
    ...
    <table class="center table justify" width="97%">
        ...
        <tr>
            ...
            <td width="25%">
                @if(isset($reqcandidato->agencia))
                    {{ $reqcandidato->agencia }}
                @else
                    {{-- Para previsualización del contrato --}}
                    @if(isset($requerimiento_informacion->agencia))
                        {{ $requerimiento_informacion->agencia }}
                    @endif
                @endif
            </td>
        </tr>
        ...
        <tr>
            ...
            <td width="50%">
                <b>ARL:</b> COLPATRIA 
                <b>AFP:</b> @if(isset($fechasContrato->entidad_afp)) {{ ($fechasContrato->entidad_afp != '' ? $fechasContrato->entidad_afp : $candidato->entidades_afp_des) }} @endif
                <b>EPS:</b> @if(isset($fechasContrato->entidad_eps)) {{ ($fechasContrato->entidad_eps != '' ? $fechasContrato->entidad_eps : $candidato->entidades_eps_des) }} @endif
            </td>
        </tr>
        ...
        <tr>
            ...
            <td width="50%">
                @if(isset($reqcandidato->nomina_contrato))
                    {{ $reqcandidato->nomina_contrato }}
                @else
                    {{-- Para previsualización del contrato --}}
                    @if(isset($requerimiento_informacion->nomina_contrato))
                        {{ $requerimiento_informacion->nomina_contrato }}
                    @endif
                @endif
            </td>
        </tr>
    ...
    <table class="center table justify mt-2" width="97%">
        <tr>
            <td>
                ...
                Por acuerdo expreso o tácito de las partes, podrán repartirse las horas de la jornada ordinaria, en la forma prevista en el articulo 164 del C.S.T.

                <div style="page-break-after:always;"></div>

                , teniendo en cuenta que los tiempos de descanso entre las secciones de la jornada, no se computan dentro de la misma, según el articulo 167 ibidem.

                Cualquier hora extra o trabajo adicional deberá ser autorizado por el empleador, la empresa usuaria o sus representantes.
                ...
                p) Las demás funciones que se le indiquen oportunamente. Parágrafo:
                ...
                Pagina 1/4
                señalada, es decir mientras subsistan las causas que le dieron origen y la materia del trabajo
                ...
                Empresa Usuaria, disposiciones que manifiesta conocer y se compromete a acatar.
                ...
                sumas en dinero o en especie que ocasionalmente y por mera liberalidad recibe o llegue a recibir en el futuro adicional a su salario ordinario,
                el trabajador del empleador o de la empresa usuaria, como propinas, primas,
                bonificaciones o gratificaciones ocasionales, participación de utilidades,

                y lo que recibe en dinero o en especie no para su beneficio como ayudas o auxilios habituales u ocasionales,
                tales como alimentación, o vestuario, bonificaciones ocasionales o cualquier otra que reciba, durante la vigencia del contrato de trabajo,
                ni aquellos que se hacen, no para enriquecer su patrimonio, sino para desempeñar a cabalidad sus funciones, como gastos de representación,
                medios de transporte, elementos de trabajo y otros semejantes. Tampoco constituyen salario las prestaciones sociales de que tratan los títulos VIII y IX del Código Sustantivo del Trabajo,
                ni los beneficios o auxilios habituales u ocasionales acordados convencional o contractualmente u otorgados en forma extralegal por el empleador o de la empresa usuaria, tales como la alimentación, habitación o vestuario, las primas extralegales, de vacaciones, de servicios o de navidad.

                Igualmente, y conforme lo ordena el articulo 17 de la Ley 344 de 1.996 los pagos aquí señalados, que no constituyen salario no hacen parte de la
                ...
                la remuneración, el cual no constituirá salario pues no se encamina a enriquecer el patrimonio del trabajador.
                ...
                Cuando la necesidad de este trabajo se presente de manera imprevista o inaplazable, deberá ejecutarse y
                ...
                entre las 21 Horas (9 P.M.) y las 6 Horas (6 A.M.).
                ...
                respectivo turno no exceda de 6 horas al día y 36 a la semana.
                ...
                hasta diez (10) horas diarias sin lugar a ningún recargo por trabajo suplementario, cuando el numero de horas de trabajo no exceda el promedio de cuarenta y ocho (48) horas semanales dentro de la jornada ordinaria de 6 A.M. a 9 P.M.
                ...
                el espacio reservado para cláusulas adicionales en el presente contrato.
                ...
                que se consagran como obligaciones especiales del trabajador las siguientes:
                ...
                utilizar y/o emplear para sí, o para ot                        ra persona natural o jurídica, la información que le ha sido entregada con ocasión de las labores
                ...
                virtud del no cumplimiento de estas obligaciones. 
                ...
                62 CST, y será justa causa de terminación del contrato laboral.
                ...
                reglamentario 1377 de 2007 que contienen la normas sobre protección y manejo de datos personales.
                ...
                cinco (5) años más, que se cuentan a partir de la fecha de su terminación.
                ...
                y cualquier otro devengo causado en favor del trabajador,

                en cualquier tiempo y más concretamente, a la terminación del presente
                ...
                fijará de acuerdo con el monto del salario, la importancia del invento o descubrimiento, el beneficio que reporte al empleador u otros factores similares.
                ...
                sin limitación geográfica o territorial alguna.
