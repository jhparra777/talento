...
<body>
    ...
    <table class="center table justify" width="97%">
        ...
        <tr>
            ...
            <td width="50%">
                <b>ARL:</b> COLPATRIA  <b>AFP:</b> {{ $candidato->entidades_afp_des }} <b>EPS:</b> {{ $candidato->entidades_eps_des }}
            </td>
        </tr>
        ...
        @if($adicionales_creadas->count() > 0)
            @foreach($adicionales_creadas as $clausula)
                ...
                @if (isset($empresa_contrata))
                    ...
                    @endif
                @else
                    @include('admin.clausulas.template.layout', ["nuevo_cuerpo" => $clausula->contenido_clausula, 'opcion_firma' => $clausula->opcion_firma])
                @endif
