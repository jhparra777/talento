 ...
 <div class="panel panel-primary">
  	<div class="panel-body">
   		<div class="panel-heading">
   			<h1 class="title">CONTRATO DE TRABAJO </br>POR EL TIEMPO QUE DURE LA REALIZACIÓN DE LA OBRA O LABOR CONTRATADA</h1>
   		</div>
   	<div>
 	...
 	<table class="table">
 		<tr>
	  		<td>
	   			<label class="col-md-12"> Nombre del Empleador: </label> 
	   		</td>

	   		<td class="col-md-12">
	   			@if(isset(FuncionesGlobales::sitio()->logo)) {{FuncionesGlobales::sitio()->nombre}} @endif
	   		</td>
	    	<td>
	    		<label class="col-md-12" > NIT del Empleador: </label>
	    	</td>
	    	<td class="col-md-12">
		...
		<tr>
	 		<td>
	 			<label class="col-md-12"> Domicilio del Empleador: </label>
	 		</td>
	 		<td class="col-md-12"> {{$requerimientos->direccion_cliente}} </td>
	 		<td>
	 			<label class="col-md-12"> Ciudad: </label>
	 		</td>


	 		<td class="col-md-12"> SANTIAGO DE CALI </td>


	 		<td>
	 			<label class="col-md-12"> Telefono: </label>
	 		</td>
	 		<td class="col-md-12"> {{ $requerimientos->telefono_cliente }} </td>
		</tr>

		<tr>
	 		<td>
	 			<label class="col-md-12"> Nombre del trabajador: </label>
	 		</td>
	 		<td class="col-md-12">
		...
		<tr>
	 		<td>
	 			<label class="col-md-12"> Cédula Ciudadanía: </label>
	 		</td>
	 		<td class="col-md-12">
	 			{{$candidato->numero_id}}
	 		</td> 
		...
		<tr>
	 		<td>
	 			<label class="col-md-12"> Direccion del Trabajador: </label>
	 		</td>
	 		<td class="col-md-12"> {{$candidato->direccion}} </td>
		</tr>
		...
		<tr>
	 		...
	 		<td class="col-md-12">Telefono: </td>
	 		<td class="col-md-12"> {{$candidato->telefono_movil}} </td>
		</tr>

		<tr>
	 		<td>
	 			<label class="col-md-12"> Lugar y fecha de nacimiento: </label>
	 		</td>
		...
		<tr>
	 		<td>
	 			<label class="col-md-12"> Afiliaciones: </label>
	 		</td>
	 		<td class="col-md-12">
	 			<span> ARL: </span> COLPATRIA  <span>AFP:</span> {{$candidato->entidades_afp_des}} <span>EPS:</span> {{$candidato->entidades_eps_des}}
	 		</td>
		</tr>

		<tr>
	 		<td>
	 			<label class="col-md-12"> Empresa usuaria: </label>
	 		</td>
	 		<td class="col-md-12">
		...
		<tr>
	 		...
	 		<td> <label class="col-md-12"> Actividad particular a desarrollar: 
	 		</label> </td>
	 		<td>{{$reqcandidato->funciones}}</td>

		</tr>

		<tr>
	 		<td> <label class="col-md-12"> Fecha de inicio: </label> </td>
	 		<td class="col-md-12"> {{$reqcandidato->fecha_inicio_contrato}} </td>
		</tr>

		<tr>
	 		<td>
	 			<label class="col-md-12">Salario Basico: </label>
	 		</td>
	 		<td class="col-md-12"> {{$reqcandidato->salario}} </td>
		</tr>

		<tr>
	 		<td>
	 			<label class="col-md-12">Periodos de pagos: </label>
	 		</td>
	 		<td class="col-md-12">  {{$reqcandidato->tipo_salarios}} </td>
		</tr>
	</table>
	...
	<ul>
	 	...
	 	<li>
	 		p) Las demás funciones que se le indiquen oportunamente. Parágrafo:<br><br>
			...
			Para constancia se firma en dos ejemplares del mismo tenor y valor, en la ciudad y fecha que se indican a continuacion.<br>
