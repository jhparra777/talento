...
@section('contenedor')
    ...
    @include('req.layout.includes._section_header_breadcrumb', ['page_header' => "Documentos contratación | $datos_candidato->nombres $datos_candidato->primer_apellido $datos_candidato->segundo_apellido", 
