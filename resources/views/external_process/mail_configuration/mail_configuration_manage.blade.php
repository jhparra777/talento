...
@section('content')
	...
	<div class="container">
		<div class="row">
			...
			<form 
				...
				id="frmActualizarConfiguracion" 
				data-smk-icon="glyphicon-remove-sign"
			>
				{{ csrf_field() }}
				<input type="hidden" name="configuracion_id" id="configuracion_id" value="{{ $configuracion_correo->id }}">
			  	...
			  	<div class="col-md-12 mb-2">
			  		<div class="form-group">
				    	...
				    	<input 
				    		...
				    		value="{{ $configuracion_correo->nombre_configuracion }}" 
				    		required 
				    	>
				  	</div>
			  	</div>
			  			...
			  			<div class="panel panel-default">
						  	<div class="panel-body">
						  		<div class="file-button">
									<span>Imagen</span>
									<input type="file" name="imagen_header" id="imagenHeader">
								</div>
								...
								<div class="text-center mt-3">
									<img 
										src="{{ asset("templates_src/conf_$configuracion_correo->id/$configuracion_correo->imagen_header") }}" 
										id="imgHeader" 
										alt="🖼️" 
										width="300"
									>
			  		...
			  		<div class="form-group">
			  			...
			  			<div class="panel panel-default">
						  	<div class="panel-body">
						    	<div class="file-button">
									<span>Imagen</span>
									<input type="file" name="imagen_fondo_header" id="imagenFondoHeader">
								</div>
								...
								<div class="text-center mt-3">
									<img 
										src="{{ asset("templates_src/conf_$configuracion_correo->id/$configuracion_correo->imagen_fondo_header") }}" 
										id="imgFondoHeader" 
										alt="🖼️" 
										width="300"
									>
			  		...
			  		<div class="form-group">
			  			...
			  			<div class="panel panel-default">
						  	<div class="panel-body">
						    	<div class="file-button">
									<span>Imagen</span>
									<input type="file" name="imagen_footer" id="imagenFooter">
								</div>
								...
								<div class="text-center mt-3">
									<img 
										src="{{ asset("templates_src/conf_$configuracion_correo->id/$configuracion_correo->imagen_footer") }}" 
										id="imgFooter" 
										alt="🖼️" 
										width="300"
									>
			  		...
			  		<div class="form-group">
			  			...
			  			<div class="panel panel-default">
						  	<div class="panel-body">
						    	<div class="file-button">
									<span>Imagen</span>
									<input type="file" name="imagen_sub_footer" id="imagenSubFooter">
								</div>
								...
								<div class="text-center mt-3">
									<img 
										src="{{ asset("templates_src/conf_$configuracion_correo->id/$configuracion_correo->imagen_sub_footer") }}" 
										id="imgSubFooter" 
										alt="🖼️" 
										width="300"
									>
			  	...
			  	<div class="col-md-6 mb-2">
			  		<div class="form-group">
				    	...
				    	<input 
				    		...
				    		id="color_principal"
				    		value="{{ $configuracion_correo->color_principal }}" 
				    		required 
				    	>
				  	</div>
			  	</div>
			  	...
			  	<div class="col-md-6 mb-2">
			  		<div class="form-group">
				    	...
				    	<input 
				    		...
				    		id="color_secundario"
				    		value="{{ $configuracion_correo->color_secundario }}" 
				    		required 
				    	>
				  	</div>
			  	</div>
			  	...
			  	<div class="col-md-1">
	                ...
	                <label class="toggle" for="socialFacebook">
	                    ...
	                    <input
	                        ...
	                        {{ $configuracion_correo->social_facebook ? 'checked' : ''  }}
	                    >
	            ...
	            <div class="col-md-1">
	                ...
	                <label class="toggle" for="socialTwitter">
	                    ...
	                    <input
	                        ...
	                        {{ $configuracion_correo->social_twitter ? 'checked' : ''  }}
	                    >
	            ...
	            <div class="col-md-1">
	                ...
	                <label class="toggle" for="socialLinkedIn">
	                    ...
	                    <input
	                        ...
	                        {{ $configuracion_correo->social_linkedin ? 'checked' : ''  }}
	                    >
	            ...
	            <div class="col-md-1">
	                ...
	                <label class="toggle" for="socialInstagram">
	                    ...
	                    <input
	                        ...
	                        {{ $configuracion_correo->social_instagram ? 'checked' : ''  }}
	                    >
	            ...
	            <div class="col-md-1">
	                ...
	                <label class="toggle" for="socialWhatsapp">
	                    ...
	                    <input
	                        ...
	                        {{ $configuracion_correo->social_whatsapp ? 'checked' : ''  }}
	                    >
			...
			<div class="col-md-12 mt-3 mb-4">
		  		<button type="button" class="btn btn-success" id="actualizarConfiguracion">Guardar</button>
	...
	@include('external_process.mail_configuration.src.js.mail_configuration_update_script')
@stop